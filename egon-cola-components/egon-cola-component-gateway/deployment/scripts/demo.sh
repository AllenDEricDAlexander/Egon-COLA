...
command_build() {
  "${repo_root}/mvnw" -B -ntp -f "${repo_root}/egon-cola-components/pom.xml" \
    -pl egon-cola-component-gateway/egon-cola-component-gateway-test/egon-cola-component-gateway-test-http-provider,egon-cola-component-gateway/egon-cola-component-gateway-test/egon-cola-component-gateway-test-webflux-http-provider,egon-cola-component-gateway/egon-cola-component-gateway-test/egon-cola-component-gateway-test-rpc-provider,egon-cola-component-gateway/egon-cola-component-gateway-test/egon-cola-component-gateway-test-rpc-consumer \
