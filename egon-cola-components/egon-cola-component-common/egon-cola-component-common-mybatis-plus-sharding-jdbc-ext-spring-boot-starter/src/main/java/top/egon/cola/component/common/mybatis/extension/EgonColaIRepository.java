...
/**
 * Explicit MyBatis-Plus 3.5.16 IRepository contract for EgonModel persistence.
 *
 * @param <T> concrete EgonModel type
 */
public interface EgonColaIRepository<T extends EgonModel<T>> extends IRepository<T> {
