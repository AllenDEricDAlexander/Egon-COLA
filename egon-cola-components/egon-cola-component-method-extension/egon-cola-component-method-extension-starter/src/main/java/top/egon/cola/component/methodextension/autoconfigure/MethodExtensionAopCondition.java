...
final class MethodExtensionAopCondition extends SpringBootCondition {
    ...
    public ConditionOutcome getMatchOutcome(
        ...
        ConditionMessage message = ConditionMessage.forCondition("Method Extension AOP engine")
                .because("effective engine is " + engine);
        return engine == MethodExtensionEngine.AOP
