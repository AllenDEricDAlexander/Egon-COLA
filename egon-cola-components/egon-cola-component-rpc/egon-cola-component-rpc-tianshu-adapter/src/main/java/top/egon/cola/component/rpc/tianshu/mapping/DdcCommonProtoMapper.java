...
import top.egon.cola.component.tianshu.model.config.DdcAckStatus;
import top.egon.cola.component.tianshu.model.config.DdcConfigFormat;
...
public final class DdcCommonProtoMapper {
    ...
    public top.egon.cola.component.rpc.tianshu.contract.proto.v1.DdcScope toScope(
            String bizCode,
            String env,
            String appCode) {
        return top.egon.cola.component.rpc.tianshu.contract.proto.v1.DdcScope
                .newBuilder()
    ...
    public top.egon.cola.component.rpc.tianshu.contract.proto.v1.DdcLeaseSession toProto(
            top.egon.cola.component.tianshu.model.lease.DdcLeaseSession value) {
        requireObject(value, "leaseSession");
        return checked(top.egon.cola.component.rpc.tianshu.contract.proto.v1.DdcLeaseSession
                .newBuilder()
    ...
    public top.egon.cola.component.tianshu.model.lease.DdcLeaseSession fromProto(
            top.egon.cola.component.rpc.tianshu.contract.proto.v1.DdcLeaseSession value) {
        checked(value);
        return new top.egon.cola.component.tianshu.model.lease.DdcLeaseSession(
    ...
    public top.egon.cola.component.rpc.tianshu.contract.proto.v1.DdcLeaseOperationResult toProto(
    ...
    public DdcLeaseOperationResult fromProto(
            top.egon.cola.component.rpc.tianshu.contract.proto.v1.DdcLeaseOperationResult value) {
        checked(value);
    ...
    public top.egon.cola.component.rpc.tianshu.contract.proto.v1.DdcServiceKey toProto(
            DdcServiceKey value) {
        requireObject(value, "serviceKey");
        return checked(top.egon.cola.component.rpc.tianshu.contract.proto.v1.DdcServiceKey
                .newBuilder()
    ...
    public DdcServiceKey fromProto(
            top.egon.cola.component.rpc.tianshu.contract.proto.v1.DdcServiceKey value) {
        checked(value);
    ...
    public top.egon.cola.component.rpc.tianshu.contract.proto.v1.DdcServiceQuery toProto(
            DdcServiceQuery value) {
        requireObject(value, "serviceQuery");
        var builder = top.egon.cola.component.rpc.tianshu.contract.proto.v1.DdcServiceQuery
                .newBuilder();
    ...
    public DdcServiceQuery fromProto(
            top.egon.cola.component.rpc.tianshu.contract.proto.v1.DdcServiceQuery value) {
        checked(value);
    ...
    public top.egon.cola.component.rpc.tianshu.contract.proto.v1.DdcLeaseRole toProto(
            DdcLeaseRole value) {
    ...
    public top.egon.cola.component.rpc.tianshu.contract.proto.v1.DdcLeaseOperationStatus toProto(
    ...
    public top.egon.cola.component.rpc.tianshu.contract.proto.v1.DdcServiceKind toProto(
    ...
    public top.egon.cola.component.rpc.tianshu.contract.proto.v1.DdcAckStatus toProto(
            DdcAckStatus value) {
    ...
    public top.egon.cola.component.rpc.tianshu.contract.proto.v1.DdcAckStatus toProtoAckStatus(
            String value) {
    ...
    public top.egon.cola.component.rpc.tianshu.contract.proto.v1.DdcConfigFormat toProtoFormat(
            String value) {
        try {
    ...
    public top.egon.cola.component.rpc.tianshu.contract.proto.v1.DdcPublishStatus toProto(
