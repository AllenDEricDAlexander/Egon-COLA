...
public final class DdcRegistryProtoMapper {
    ...
    public top.egon.cola.component.rpc.tianshu.contract.proto.v1.DdcServiceInstance toProto(
    ...
    public DdcServiceInstance fromProto(
            top.egon.cola.component.rpc.tianshu.contract.proto.v1.DdcServiceInstance value) {
        common.checked(value);
        if (!value.hasServiceKey()) {
            throw new IllegalArgumentException("serviceKey is required");
        }
    ...
    private DdcServiceLeaseRequest lease(
            top.egon.cola.component.tianshu.model.registry.DdcServiceKey serviceKey,
            String instanceId,
            String leaseId) {
        if (serviceKey == null) {
            throw new IllegalArgumentException("serviceKey is required");
