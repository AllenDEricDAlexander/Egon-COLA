package top.egon.cola.platform.tianquan.jianshen.admin.authorization.runtime.repository.http;
...
import top.egon.cola.platform.tianquan.jianshen.admin.authorization.runtime.repository.http.GatewayAdminControlPlaneTransport;
import top.egon.cola.platform.tianquan.jianshen.admin.authorization.runtime.domain.vo.GatewayAdminControlPlaneHttpResponseVO;
import top.egon.cola.platform.tianquan.jianshen.admin.authorization.runtime.repository.internal.JdkGatewayAdminControlPlaneTransport;
import top.egon.cola.platform.tianquan.jianshen.admin.authorization.runtime.repository.internal.GatewayAdminControlPlaneResponse;
import top.egon.cola.platform.tianquan.jianshen.admin.authorization.runtime.domain.vo.GatewayAdminSnapshotVO;
...
import top.egon.cola.platform.tianquan.jianshen.admin.authorization.runtime.domain.vo.GatewayProviderInstanceVO;
import top.egon.cola.platform.tianquan.jianshen.admin.authorization.runtime.domain.GatewayServiceKey;
import top.egon.cola.platform.tianquan.jianshen.admin.authorization.runtime.domain.vo.GatewayConsistencyObservationVO;
import top.egon.cola.platform.tianquan.jianshen.admin.authorization.runtime.domain.vo.BearerCredentialVO;
import top.egon.cola.platform.tianquan.jianshen.admin.authorization.runtime.repository.GatewayAdminSnapshotRepository;
