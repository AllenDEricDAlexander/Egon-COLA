package top.egon.cola.platform.tianquan.jianshen.admin.authorization.policy.management.repository.jpa;
...
import top.egon.cola.platform.tianquan.jianshen.admin.authorization.policy.management.domain.po.ManagementRolePO;
...
import top.egon.cola.platform.tianquan.jianshen.admin.iam.position.snapshot.domain.enums.UserPositionSnapshotStatusEnum;
import top.egon.cola.platform.tianquan.jianshen.admin.authorization.policy.management.domain.dto.SavePolicyCommandDTO;
import top.egon.cola.platform.tianquan.jianshen.admin.authorization.policy.management.domain.po.ManagementPolicySubjectPO;
import top.egon.cola.platform.tianquan.jianshen.admin.authorization.policy.management.domain.po.ManagementPolicyScopePO;
...
import top.egon.cola.platform.tianquan.jianshen.admin.authorization.policy.management.repository.ManagementPolicyFactRepository;
import top.egon.cola.platform.tianquan.jianshen.admin.authorization.policy.management.repository.ManagementPolicyControlRepository;
import top.egon.cola.platform.tianquan.jianshen.admin.authorization.policy.management.domain.dto.SaveCommandDTO;
import top.egon.cola.platform.tianquan.jianshen.admin.authorization.policy.management.domain.vo.PolicyVO;
import top.egon.cola.platform.tianquan.jianshen.admin.authorization.policy.management.domain.vo.ManagementPolicyRestrictionsVO;
import top.egon.cola.platform.tianquan.jianshen.admin.authorization.policy.management.domain.vo.CapabilityVO;
import top.egon.cola.platform.tianquan.jianshen.admin.authorization.policy.management.domain.vo.ManagedUserVO;
import top.egon.cola.platform.tianquan.jianshen.admin.authorization.policy.management.domain.vo.ManagedRoleVO;
import top.egon.cola.platform.tianquan.jianshen.admin.authorization.policy.management.domain.vo.ManagementPolicyScopeVO;
import top.egon.cola.platform.tianquan.jianshen.admin.authorization.policy.management.domain.vo.ManagementPolicySubjectVO;
import top.egon.cola.platform.tianquan.jianshen.admin.authorization.policy.management.domain.enums.ManagementOperationOperationEnum;
import top.egon.cola.platform.tianquan.jianshen.admin.authorization.policy.management.domain.enums.ManagementPolicyStatusEnum;
import top.egon.cola.platform.tianquan.jianshen.admin.authorization.policy.management.domain.enums.ManagementPolicyRiskLevelEnum;
import top.egon.cola.platform.tianquan.jianshen.admin.authorization.policy.management.domain.enums.ManagementPolicyAuthenticationStrengthEnum;
import top.egon.cola.platform.tianquan.jianshen.admin.authorization.policy.management.domain.enums.ManagementSubjectSubjectTypeEnum;
...
public class JpaManagementPolicyRepository implements
    ...
    public List<ManagementPolicyDecisionService.ManagementPolicyFact> policies(
        ...
        List<ManagementPolicyPO> candidates = entityManager.createQuery("""
                ...
                .setParameter("positionStatus",
                        top.egon.cola.platform.tianquan.jianshen.admin.iam.position.snapshot.domain.enums
    ...
    public List<ManagedUserVO> manageableUsers(
        ...
        List<Object[]> rows = entityManager.createQuery("""
                        ...
                        """, Object[].class)
                .setParameter("tenantId", Long.valueOf(tenantId))
                .setParameter("status", top.egon.cola.platform.tianquan.jianshen.admin.iam.user.domain.enums
