package top.egon.cola.platform.tianquan.jianshen.admin.iam.organization.domain.po;
...
/** A tenant-scoped user-to-organization membership. */
@Entity(name = "UserOrganizationAssignmentEntity")
@Table(name = "rbac3_user_org_assignment")
public class UserOrganizationAssignmentPO extends TenantScopedPO {
    ...
    protected UserOrganizationAssignmentPO() {
    }

    public UserOrganizationAssignmentPO(
            Long id,
            Long tenantId,
            Long userId,
            Long orgUnitId,
