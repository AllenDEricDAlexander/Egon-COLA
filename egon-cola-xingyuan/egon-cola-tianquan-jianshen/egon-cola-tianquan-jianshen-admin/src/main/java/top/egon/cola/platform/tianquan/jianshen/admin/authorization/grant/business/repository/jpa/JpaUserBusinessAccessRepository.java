package top.egon.cola.platform.tianquan.jianshen.admin.authorization.grant.business.repository.jpa;
...
import top.egon.cola.platform.tianquan.jianshen.admin.authorization.grant.business.domain.po.UserBusinessAccessPO;
...
public class JpaUserBusinessAccessRepository
    ...
    public List<UserApplicationAccessVO> applicationAccesses(
        ...
        return entityManager.createQuery("""
                ...
                .setParameter("userId", userId)
                .setParameter("at", at)
                .setParameter("appStatus", top.egon.cola.platform.tianquan.jianshen.admin.iam.application.domain.enums.ApplicationStatusEnum.ACTIVE)
                .setParameter("roleStatus", top.egon.cola.platform.tianquan.jianshen.admin.iam.role.domain.enums.RoleStatusEnum.ACTIVE)
                .setParameter("assignmentStatus", top.egon.cola.platform.tianquan.jianshen.admin.authorization.grant.userrole.domain.enums.UserRoleAssignmentStatusEnum.ACTIVE)
