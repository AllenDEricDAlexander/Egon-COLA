...
import top.egon.cola.platform.tianquan.jianshen.admin.shared.tenant.domain.exception.TenantContextResolutionException;
...
public final class TenantContextFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        } catch (TenantContextResolutionException error) {
