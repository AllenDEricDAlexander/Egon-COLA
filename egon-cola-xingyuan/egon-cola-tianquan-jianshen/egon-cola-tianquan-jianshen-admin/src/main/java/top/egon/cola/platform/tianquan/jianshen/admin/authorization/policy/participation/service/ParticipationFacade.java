package top.egon.cola.platform.tianquan.jianshen.admin.authorization.policy.participation.service;

import top.egon.cola.platform.tianquan.shoubing.contract.ServiceIdentityPrincipal;
import top.egon.cola.platform.tianquan.jianshen.contract.participation.BusinessParticipationCommand;
import top.egon.cola.platform.tianquan.jianshen.core.participation.OperationSodSpecification;
...
import top.egon.cola.platform.tianquan.jianshen.admin.authorization.policy.participation.repository.OperationSodRuleRepository;
...
import top.egon.cola.platform.tianquan.jianshen.admin.authorization.policy.participation.domain.vo.RecordResultVO;
import top.egon.cola.platform.tianquan.jianshen.admin.authorization.policy.participation.domain.dto.ConflictQueryDTO;
import top.egon.cola.platform.tianquan.jianshen.admin.authorization.policy.participation.domain.vo.ConflictDecisionVO;
