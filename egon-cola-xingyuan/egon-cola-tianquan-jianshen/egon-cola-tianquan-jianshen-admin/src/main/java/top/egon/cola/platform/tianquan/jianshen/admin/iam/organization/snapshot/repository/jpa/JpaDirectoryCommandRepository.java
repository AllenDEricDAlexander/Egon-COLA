...
import top.egon.cola.platform.tianquan.jianshen.admin.iam.organization.snapshot.domain.vo.DirectorySyncVO;
import top.egon.cola.platform.tianquan.jianshen.admin.iam.organization.snapshot.domain.vo.IngestionResultVO;
import top.egon.cola.platform.tianquan.jianshen.admin.iam.organization.snapshot.domain.vo.MaterializationResultVO;
import top.egon.cola.platform.tianquan.jianshen.admin.iam.organization.snapshot.domain.vo.SnapshotModelVO;
import top.egon.cola.platform.tianquan.jianshen.admin.iam.organization.snapshot.repository.DirectoryCommandRepository;
import top.egon.cola.platform.tianquan.jianshen.admin.iam.organization.snapshot.repository.jpa.DirectorySnapshotMaterializer;
import top.egon.cola.platform.tianquan.jianshen.admin.iam.organization.snapshot.repository.jpa.JpaDirectorySnapshotRepository;
import top.egon.cola.platform.tianquan.jianshen.admin.iam.organization.snapshot.domain.enums.DirectorySnapshotOutcomeEnum;
import top.egon.cola.platform.tianquan.jianshen.admin.iam.organization.snapshot.domain.enums.DirectorySnapshotStatusEnum;
