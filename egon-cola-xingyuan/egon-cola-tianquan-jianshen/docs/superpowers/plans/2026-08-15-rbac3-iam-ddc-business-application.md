...
~~~java
// RBAC package: top.egon.cola.platform.tianquan.jianshen.admin.iam.business.service
...
- Create: egon-cola-xingyuan/egon-cola-tianquan-jianshen/egon-cola-tianquan-jianshen-admin/src/main/resources/db/migration/V6__adopt_ddc_business_application_authorization_scope.sql.
...
**Produces:** The exact top.egon.cola.platform.tianquan.jianshen.admin.iam tree and no retained legacy IAM business package.
