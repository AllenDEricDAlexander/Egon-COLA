...
verify() {
  check_config
  local migrations
  local admin_root="${RBAC3_MODULE_ROOT}/egon-cola-tianquan-jianshen-admin"
  ...
  [[ -f "${RBAC3_MODULE_ROOT}/egon-cola-tianquan-jianshen-admin/src/main/resources/db/migration/V1__create_rbac3_schema.sql" ]]
  [[ -f "${RBAC3_MODULE_ROOT}/egon-cola-tianquan-jianshen-admin/src/main/resources/db/migration/V2__add_session_strong_authentication_time.sql" ]]
  [[ -f "${RBAC3_MODULE_ROOT}/egon-cola-tianquan-jianshen-admin/src/main/resources/db/migration/V5__remove_sessions_and_minimize_authorization_user.sql" ]]
  [[ ! -e "${RBAC3_MODULE_ROOT}/egon-cola-tianquan-jianshen-test" ]] \
    || rbac3_die "an independent RBAC3 test module is forbidden"

  rg -q 'flyway_schema_history_rbac3' "${RBAC3_MODULE_ROOT}/egon-cola-tianquan-jianshen-admin/src/main"
  rg -q 'flyway_schema_history_outbox' "${RBAC3_MODULE_ROOT}/egon-cola-tianquan-jianshen-admin/src/main"
  ...
  if rg -n 'egon-cola-tianquan-jianshen-admin' \
      "${RBAC3_MODULE_ROOT}/egon-cola-tianquan-jianshen-starter/pom.xml" \
      "${RBAC3_MODULE_ROOT}/egon-cola-tianquan-jianshen-gateway-adapter/pom.xml"; then
