...
vi.mock('@egon-cola/xingyuan-admin-web-shared', async () => {
    const actual = await vi.importActual<typeof import('@egon-cola/xingyuan-admin-web-shared')>('@egon-cola/xingyuan-admin-web-shared')
  return {
      ...actual,
