/**
 * 在统一 Tianquan-Shoubing 与 Gateway 安全扩展机制之间提供适配层。
 * 模块复用 Starter 的 JWT 与用户实时状态校验规则，但通过 Gateway 原生 SPI 完成凭据提取、
 * 身份认证和可信身份传递，不引入 Servlet 过滤器。
 *
 * <p>Provides the adapter layer between the unified Tianquan-Shoubing and the Gateway security extension model.
 ...
 */
package top.egon.cola.platform.tianquan.shoubing.gateway;
