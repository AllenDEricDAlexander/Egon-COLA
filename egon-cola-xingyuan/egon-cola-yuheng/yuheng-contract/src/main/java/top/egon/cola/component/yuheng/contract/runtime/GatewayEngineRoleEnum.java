 ...
 *
 * <p>角色由可执行程序确定，并通过 Tianshu 元数据上报；不能由部署配置切换。
 * English summary: Defines the fixed engine roles reported through Tianshu metadata.
 */
public enum GatewayEngineRoleEnum {
     ...
     *
     * @param value Tianshu 角色元数据，允许为空；nullable Tianshu role metadata
