...
class McpReleaseContentFactoryTest {
    ...
    void ignoresForgedExposureOnManualOperation() {
        top.egon.cola.component.yuheng.admin.catalog.domain.vo.GatewayCurrentOperationDefinitionVO starter = current(
                "operation-1",
                "http:orders:GET:/orders",
                "HTTP",
                Map.of("mcpExposure", exposure(
        ...
        when(catalog.loadCurrentOperationDefinitions("group-1"))
                .thenReturn(List.of(
                        new top.egon.cola.component.yuheng.admin.catalog.domain.vo.GatewayCurrentOperationDefinitionVO(
                                manualOperation,
                                starter.definition()
                        )
                ));
    ...
    private top.egon.cola.component.yuheng.admin.catalog.domain.vo.GatewayCurrentOperationDefinitionVO current(
            String operationId,
            String operationKey,
            String protocol,
    ...
    private top.egon.cola.component.yuheng.admin.catalog.domain.vo.GatewayCurrentOperationDefinitionVO current(
        ...
        return new top.egon.cola.component.yuheng.admin.catalog.domain.vo.GatewayCurrentOperationDefinitionVO(
                operation,
                definition
        );
    }
