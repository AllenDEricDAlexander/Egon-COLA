...
class GatewayRuleChunkGarbageCollectorTest {
    ...
    void publishesYamlWithoutOnlyTheExpiredChunk() {
        ...
        verify(client).findConfig(new top.egon.cola.component.tianshu.model.management.DdcManagementConfigQuery(
                "infra", "test", "ge"));
    ...
    private top.egon.cola.component.yuheng.admin.release.domain.po.GatewayChunkCleanupCandidatePO candidate(
        ...
        return new top.egon.cola.component.yuheng.admin.release.domain.po.GatewayChunkCleanupCandidatePO(
                ...
                "default",
                configKey,
                targetVersion, new top.egon.cola.component.yuheng.admin.release.domain.dto.GatewayPublicationScopeDTO("infra", "test", "ge", top.egon.cola.component.yuheng.contract.runtime.GatewayEngineRoleEnum.API_RPC)
        );
    }
}
