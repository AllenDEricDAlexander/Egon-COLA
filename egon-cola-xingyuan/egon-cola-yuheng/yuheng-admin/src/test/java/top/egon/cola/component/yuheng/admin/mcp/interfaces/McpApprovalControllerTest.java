...
class McpApprovalControllerTest {
    ...
    void returnsPlaintextOnceAndPersistsOnlyBoundDigests() {
        ...
        top.egon.cola.component.yuheng.admin.mcp.domain.vo.McpApprovalVO response = controller.issue(
                new top.egon.cola.component.yuheng.admin.mcp.domain.dto.McpApprovalRequestDTO(
                        "billing",
                        "pay_invoice",
                        arguments,
                        90L
