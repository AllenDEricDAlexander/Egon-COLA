...
class GatewayCallEventConsumerHandlerTest {
    ...
    void projectsValidEventAndRecordsPoisonForInvalidJson()
        ...
        assertEquals(
                top.egon.cola.component.yuheng.admin.observability.domain.enums.GatewayCallEventConsumeResultEnum.PROJECTED,
        ...
        assertEquals(
                top.egon.cola.component.yuheng.admin.observability.domain.enums.GatewayCallEventConsumeResultEnum.POISON_RECORDED,
                handler.handle(new ConsumerRecord<>(
                        "calls",
                        0,
                        11,
