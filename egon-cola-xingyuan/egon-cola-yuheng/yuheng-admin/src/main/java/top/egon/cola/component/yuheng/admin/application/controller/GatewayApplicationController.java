package top.egon.cola.component.yuheng.admin.application.controller;
...
import top.egon.cola.component.yuheng.admin.application.domain.dto.GatewayApplicationCreateRequestDTO;
import top.egon.cola.component.yuheng.admin.application.domain.dto.GatewayApplicationUpdateRequestDTO;
import top.egon.cola.component.yuheng.admin.application.service.GatewayApplicationService;
...
public class GatewayApplicationController {
    ...
    @GetMapping
    public List<top.egon.cola.component.yuheng.admin.application.domain.vo.GatewayApplicationVO> list(
            @RequestParam(required = false) String bizCode,
            @RequestParam(required = false) String namespace,
            @RequestParam(required = false) String env,
            @RequestParam(required = false) String appCode) {
        return service.list(new top.egon.cola.component.yuheng.admin.scope.domain.dto.GatewayScopeQueryDTO(
                bizCode,
                namespace,
                env,
                appCode
    ...
    public top.egon.cola.component.yuheng.admin.application.domain.vo.GatewayApplicationVO create(
        ...
        return service.create(
                new top.egon.cola.component.yuheng.admin.application.domain.dto.GatewayApplicationCreateCommandDTO(
                        request.bizCode(),
    ...
    @EgonGatewayPolicy(
            exposure = EgonGatewayPolicy.Exposure.EXTERNAL)
    @GetMapping("/{id}")
    public top.egon.cola.component.yuheng.admin.application.domain.vo.GatewayApplicationVO get(
    ...
    public top.egon.cola.component.yuheng.admin.application.domain.vo.GatewayApplicationVO update(
        ...
        return service.update(
                id,
                new top.egon.cola.component.yuheng.admin.application.domain.dto.GatewayApplicationUpdateCommandDTO(
                        request.displayName(),
                        request.description(),
