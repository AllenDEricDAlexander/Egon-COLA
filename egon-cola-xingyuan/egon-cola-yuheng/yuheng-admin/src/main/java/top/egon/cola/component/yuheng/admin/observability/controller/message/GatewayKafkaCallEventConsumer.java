...
import top.egon.cola.component.yuheng.admin.observability.domain.dto.GatewayKafkaConsumerSettingsDTO;
...
public final class GatewayKafkaCallEventConsumer
    ...
    private void pollAndProject() {
        ...
        for (ConsumerRecord<String, byte[]> record : records) {
            ...
            try {
                top.egon.cola.component.yuheng.admin.observability.domain.enums.GatewayCallEventConsumeResultEnum result =
