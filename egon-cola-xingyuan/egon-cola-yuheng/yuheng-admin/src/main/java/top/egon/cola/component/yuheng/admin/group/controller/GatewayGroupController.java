package top.egon.cola.component.yuheng.admin.group.controller;
...
import top.egon.cola.component.yuheng.admin.group.domain.dto.GatewayGroupCreateRequestDTO;
import top.egon.cola.component.yuheng.admin.group.domain.dto.GatewayGroupUpdateRequestDTO;
import top.egon.cola.component.yuheng.admin.group.service.GatewayGroupService;
...
public class GatewayGroupController {
    ...
    @GetMapping
    public List<top.egon.cola.component.yuheng.admin.group.domain.vo.GatewayGroupVO> list() {
        return service.list();
    }
    ...
    public top.egon.cola.component.yuheng.admin.group.domain.vo.GatewayGroupVO create(
        ...
        return service.create(
                new top.egon.cola.component.yuheng.admin.group.domain.dto.GatewayGroupCreateCommandDTO(
    ...
    @EgonGatewayPolicy(
            exposure = EgonGatewayPolicy.Exposure.EXTERNAL)
    @GetMapping("/{id}")
    public top.egon.cola.component.yuheng.admin.group.domain.vo.GatewayGroupVO get(
    ...
    public top.egon.cola.component.yuheng.admin.group.domain.vo.GatewayGroupVO update(
        ...
        return service.update(
                id,
                new top.egon.cola.component.yuheng.admin.group.domain.dto.GatewayGroupUpdateCommandDTO(
                        request.displayName(),
                        request.description(),
