package top.egon.cola.component.yuheng.admin.runtime.controller;
...
public class GatewayProjectionController {
     ...
     */
    private top.egon.cola.component.yuheng.admin.runtime.domain.dto.GatewayProviderQueryDTO query(
            String bizCode,
            String appCode,
            String env,
            String namespace,
            ...
            String group,
            String version) {
        return new top.egon.cola.component.yuheng.admin.runtime.domain.dto.GatewayProviderQueryDTO(
                bizCode,
                appCode,
                env,
                namespace,
