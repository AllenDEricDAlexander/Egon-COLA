package top.egon.cola.component.yuheng.admin.catalog.controller;
...
import top.egon.cola.component.yuheng.admin.catalog.domain.dto.GatewayManualDefinitionRequestDTO;
import top.egon.cola.component.yuheng.admin.catalog.domain.dto.GatewayManualInterfaceGroupRequestDTO;
import top.egon.cola.component.yuheng.admin.catalog.domain.dto.GatewayManualMetadataRequestDTO;
import top.egon.cola.component.yuheng.admin.catalog.domain.dto.GatewayManualOperationRequestDTO;
import top.egon.cola.component.yuheng.admin.catalog.domain.vo.GatewayCatalogResourceCreatedVO;
import top.egon.cola.component.yuheng.admin.catalog.service.GatewayCatalogService;
...
public class GatewayCatalogController {
    ...
    public top.egon.cola.component.yuheng.admin.catalog.domain.vo.GatewayCatalogTreeVO catalog(
    ...
    public GatewayCatalogResourceCreatedVO createInterfaceGroup(
        ...
        String id = service.createManualInterfaceGroup(
                applicationId,
                new top.egon.cola.component.yuheng.admin.catalog.domain.dto.GatewayManualHierarchyDTO(
    ...
    public top.egon.cola.component.yuheng.admin.catalog.domain.vo.GatewayOperationDetailVO operation(
    ...
    public top.egon.cola.component.yuheng.admin.catalog.domain.vo.GatewayOperationDetailVO updateMetadata(
        ...
        return service.updateMetadata(
                operationId,
                new top.egon.cola.component.yuheng.admin.catalog.domain.dto.GatewayManualMetadataDTO(
                        request.summary(),
                        request.tags(),
                        request.owner()
                ),
