package top.egon.cola.component.yuheng.admin.release.controller;
...
import top.egon.cola.component.yuheng.admin.release.domain.dto.GatewayReleaseCreateRequestDTO;
import top.egon.cola.component.yuheng.admin.release.domain.dto.GatewayReleaseRollbackRequestDTO;
...
public class GatewayReleaseController {
    ...
    public top.egon.cola.component.yuheng.admin.release.domain.vo.GatewayReleaseVO get(
    ...
    public top.egon.cola.component.yuheng.admin.release.domain.vo.GatewayReleaseVO rollback(
        ...
        return service.rollback(
                gatewayGroupId,
                new top.egon.cola.component.yuheng.admin.release.domain.dto.GatewayReleaseRollbackCommandDTO(
