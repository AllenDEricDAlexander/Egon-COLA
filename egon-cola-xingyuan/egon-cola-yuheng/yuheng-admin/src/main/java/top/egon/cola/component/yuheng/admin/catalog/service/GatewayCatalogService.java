...
import top.egon.cola.component.yuheng.contract.identity.GatewayOperationKey;
...
public class GatewayCatalogService {
    ...
    public top.egon.cola.component.yuheng.admin.catalog.domain.vo.GatewayCatalogTreeVO catalog(String applicationId) {
    ...
    public String createManualInterfaceGroup(
            ...
            top.egon.cola.component.yuheng.admin.catalog.domain.dto.GatewayManualHierarchyDTO hierarchy,
            AdminActor actor,
    ...
    public GatewayOperationDetailVO createManualOperation(
            ...
            AdminActor actor,
            RequestAuditContext request) {
        top.egon.cola.component.yuheng.admin.catalog.domain.vo.GatewayInterfaceGroupScopeVO scope =
    ...
    private void validateHierarchy(
            top.egon.cola.component.yuheng.admin.catalog.domain.dto.GatewayManualHierarchyDTO value) {
