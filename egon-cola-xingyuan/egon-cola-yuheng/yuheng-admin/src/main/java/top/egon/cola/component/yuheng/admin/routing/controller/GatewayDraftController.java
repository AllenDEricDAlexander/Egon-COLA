package top.egon.cola.component.yuheng.admin.routing.controller;
...
import top.egon.cola.component.yuheng.admin.routing.domain.dto.GatewayDraftMutationRequestDTO;
import top.egon.cola.component.yuheng.admin.routing.domain.dto.GatewayDraftPolicyRequestDTO;
import top.egon.cola.component.yuheng.admin.routing.domain.dto.GatewayDraftRouteRequestDTO;
...
public class GatewayDraftController {
    ...
    @GetMapping
    public top.egon.cola.component.yuheng.admin.routing.domain.vo.GatewayDraftVO get(
    ...
    public top.egon.cola.component.yuheng.admin.routing.domain.vo.GatewayDraftMutationResultVO putRoute(
        ...
        return service.putRoute(
                gatewayGroupId,
                routeId,
                new top.egon.cola.component.yuheng.admin.routing.domain.dto.GatewayRouteMutationDTO(
                        request.operationId(),
                        request.content(),
                        request.enabled(),
    ...
    public top.egon.cola.component.yuheng.admin.routing.domain.vo.GatewayDraftValidationReportVO validate(
            @PathVariable String gatewayGroupId) {
    ...
    @EgonGatewayPolicy(
            exposure = EgonGatewayPolicy.Exposure.EXTERNAL)
    @GetMapping("/diff")
    public top.egon.cola.component.yuheng.admin.routing.domain.vo.GatewayDraftDiffVO diff(
            @PathVariable String gatewayGroupId) {
