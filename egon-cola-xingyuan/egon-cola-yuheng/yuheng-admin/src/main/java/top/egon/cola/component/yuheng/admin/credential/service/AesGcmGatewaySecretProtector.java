...
import top.egon.cola.component.yuheng.admin.credential.domain.vo.GatewayProtectedSecretVO;
...
public final class AesGcmGatewaySecretProtector
     ...
     */
    @Override
    public GatewayProtectedSecretVO protect(
            String plaintext,
        ...
        try {
            ...
            return new GatewayProtectedSecretVO(
    ...
    public String unprotect(
            GatewayProtectedSecretVO secret,
            String associatedData) {
