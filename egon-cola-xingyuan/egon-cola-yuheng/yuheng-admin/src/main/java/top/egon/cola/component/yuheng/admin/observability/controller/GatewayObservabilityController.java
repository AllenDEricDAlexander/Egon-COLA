package top.egon.cola.component.yuheng.admin.observability.controller;
...
public class GatewayObservabilityController {
    ...
    public top.egon.cola.component.yuheng.admin.observability.domain.vo.GatewayPageVO<
        ...
        return service.traces(new top.egon.cola.component.yuheng.admin.observability.domain.dto.GatewayTraceQueryDTO(
                env,
                namespace,
                traceId,
                protocol,
    ...
    public top.egon.cola.component.yuheng.admin.observability.domain.vo.GatewayPageVO<
            ...
            @RequestParam(defaultValue = "1") int page,
            @RequestParam(defaultValue = "20") int size) {
        return service.audits(new top.egon.cola.component.yuheng.admin.observability.domain.dto.GatewayAuditQueryDTO(
                env,
                namespace,
                actorId,
                resourceId,
