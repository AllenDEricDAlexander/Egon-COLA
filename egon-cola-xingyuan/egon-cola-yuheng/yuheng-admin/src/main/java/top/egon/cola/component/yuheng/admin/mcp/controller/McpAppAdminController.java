...
import top.egon.cola.component.yuheng.admin.mcp.domain.dto.McpArtifactRequestDTO;
...
public class McpAppAdminController {
    ...
    public top.egon.cola.component.yuheng.admin.mcp.domain.vo.McpMutationResultVO upload(
        ...
        return service.uploadArtifact(
                new top.egon.cola.component.yuheng.admin.mcp.domain.dto.McpArtifactUploadDTO(
                        gatewayGroupId,
                        appCode,
                        version,
                        displayName,
