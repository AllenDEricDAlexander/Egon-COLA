...
import top.egon.cola.component.yuheng.admin.mcp.domain.dto.McpCapabilityRequestDTO;
...
public class McpCapabilityController {
    ...
    public top.egon.cola.component.yuheng.admin.mcp.domain.vo.McpMutationResultVO delete(
        ...
        return service.deleteCapability(
                id,
                kind(plural),
                new top.egon.cola.component.yuheng.admin.mcp.domain.dto.McpMutationControlDTO(
    ...
    public top.egon.cola.component.yuheng.admin.mcp.domain.vo.McpValidationReportVO validate(
            @PathVariable String plural,
            @PathVariable String id,
            @RequestParam String gatewayGroupId) {
        kind(plural);
     ...
     */
    private top.egon.cola.component.yuheng.admin.mcp.domain.enums.McpCapabilityKindEnum kind(String value) {
        String normalized = value.toUpperCase(Locale.ROOT)
                .replace('-', '_');
        return switch (normalized) {
            case "RESOURCES" ->
                    top.egon.cola.component.yuheng.admin.mcp.domain.enums.McpCapabilityKindEnum.RESOURCE;
            case "RESOURCE_TEMPLATES" ->
                    top.egon.cola.component.yuheng.admin.mcp.domain.enums.McpCapabilityKindEnum
                            .RESOURCE_TEMPLATE;
            case "PROMPTS" ->
                    top.egon.cola.component.yuheng.admin.mcp.domain.enums.McpCapabilityKindEnum.PROMPT;
            case "TASK_POLICIES" ->
                    top.egon.cola.component.yuheng.admin.mcp.domain.enums.McpCapabilityKindEnum.TASK_POLICY;
            case "APP_BINDINGS" ->
                    top.egon.cola.component.yuheng.admin.mcp.domain.enums.McpCapabilityKindEnum.APP_BINDING;
