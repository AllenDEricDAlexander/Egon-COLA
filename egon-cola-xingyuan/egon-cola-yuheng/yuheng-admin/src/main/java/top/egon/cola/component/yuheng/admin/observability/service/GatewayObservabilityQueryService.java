package top.egon.cola.component.yuheng.admin.observability.service;
...
public class GatewayObservabilityQueryService {
     ...
     */
    public top.egon.cola.component.yuheng.admin.observability.domain.vo.GatewayPageVO<
            top.egon.cola.component.yuheng.admin.observability.domain.vo.GatewayTraceVO> traces(
            top.egon.cola.component.yuheng.admin.observability.domain.dto.GatewayTraceQueryDTO query) {
     ...
     */
    public top.egon.cola.component.yuheng.admin.observability.domain.vo.GatewayDashboardVO dashboard(
            String bizCode,
            String appCode,
            String env,
            String namespace) {
        top.egon.cola.component.yuheng.admin.observability.domain.vo.GatewayDashboardVO summary = store.dashboard(
                env,
                namespace,
        ...
        try {
            top.egon.cola.component.yuheng.admin.runtime.service.GatewayProjectionCounts counts =
            ...
            return new top.egon.cola.component.yuheng.admin.observability.domain.vo.GatewayDashboardVO(
     ...
     */
    public top.egon.cola.component.yuheng.admin.observability.domain.vo.GatewayPageVO<
            top.egon.cola.component.yuheng.admin.observability.domain.vo.GatewayAuditVO> audits(
            top.egon.cola.component.yuheng.admin.observability.domain.dto.GatewayAuditQueryDTO query) {
