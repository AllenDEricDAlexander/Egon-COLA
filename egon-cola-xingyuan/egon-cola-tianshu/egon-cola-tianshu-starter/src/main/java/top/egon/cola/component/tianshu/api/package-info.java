/**
 * Tianshu 对外端口与扩展点的组织包，只用于归类客户端、扩展、刷新和注册接口。
 * 本包不保存实现或数据对象；实现依赖这里的端口，数据由 {@code model} 提供。
 *
 * <p>Organizational package for public Tianshu ports and extension points covering clients,
 ...
 */
@NonNullApi
package top.egon.cola.component.tianshu.api;
