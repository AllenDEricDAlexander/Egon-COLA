...
- 前端路径 `<web>/` = `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-admin-web/`；后端路径 `<admin>/` = `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-admin/`。
...
import top.egon.cola.component.tianshu.admin.service.DdcNamespaceService;
...
import top.egon.cola.component.tianshu.admin.service.DdcAppService;
