...
/**
 * 按优先级定位 favicon.png（唯一资源来源为仓库根 egon-cola-xingyuan/favicon.png）：
 *
 * 1. 显式传入的路径；
 * 2. 本包内发布文件（node_modules/@egon-cola/xingyuan-admin-web-shared/favicon.png，
...
const locateFavicon = (explicit?: string): string | null => {
  ...
  for (let level = 0; level < 6; level += 1) {
    candidates.push(resolve(dir, 'node_modules/@egon-cola/xingyuan-admin-web-shared/favicon.png'))
