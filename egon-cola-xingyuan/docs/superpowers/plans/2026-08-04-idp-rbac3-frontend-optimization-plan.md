...
### 新建: 共享包 `egon-cola-xingyuan-admin-web-shared/`
...
**Files:**
- Create: `egon-cola-xingyuan-admin-web-shared/package.json`
- Create: `egon-cola-xingyuan-admin-web-shared/tsconfig.json`
- Create: `egon-cola-xingyuan-admin-web-shared/tsconfig.app.json`

**Interfaces:**
- Produces: package name `@egon-cola/xingyuan-admin-web-shared`, version `0.1.0`, type `module`

- [ ] **Step 1: 创建 package.json**

```jsonc
{
  "name": "@egon-cola/xingyuan-admin-web-shared",
  "version": "0.1.0",
  "private": true,
  "type": "module",
...
```bash
cd egon-cola-xingyuan-admin-web-shared && npm install
```

- [ ] **Step 8: Commit**

```bash
git add egon-cola-xingyuan-admin-web-shared/
...
**Files:**
- Create: `egon-cola-xingyuan-admin-web-shared/src/theme/tokens.ts`
...
```bash
git add egon-cola-xingyuan-admin-web-shared/src/theme/tokens.ts
...
**Files:**
- Create: `egon-cola-xingyuan-admin-web-shared/src/api/jwt.ts`
- Create: `egon-cola-xingyuan-admin-web-shared/src/api/jwt.test.ts`
...
```bash
cd egon-cola-xingyuan-admin-web-shared && npx vitest run src/api/jwt.test.ts
```
...
```bash
git add egon-cola-xingyuan-admin-web-shared/src/api/jwt.ts egon-cola-xingyuan-admin-web-shared/src/api/jwt.test.ts
...
**Files:**
- Create: `egon-cola-xingyuan-admin-web-shared/src/api/errors.ts`
...
```bash
git add egon-cola-xingyuan-admin-web-shared/src/api/errors.ts
...
**Files:**
- Create: `egon-cola-xingyuan-admin-web-shared/src/auth/tokenStore.ts`
- Create: `egon-cola-xingyuan-admin-web-shared/src/auth/tokenStore.test.ts`
...
```bash
cd egon-cola-xingyuan-admin-web-shared && npx vitest run src/auth/tokenStore.test.ts
```
...
```bash
git add egon-cola-xingyuan-admin-web-shared/src/auth/tokenStore.ts egon-cola-xingyuan-admin-web-shared/src/auth/tokenStore.test.ts
...
**Files:**
- Create: `egon-cola-xingyuan-admin-web-shared/src/theme/ThemeProvider.tsx`
...
```bash
git add egon-cola-xingyuan-admin-web-shared/src/theme/ThemeProvider.tsx
...
**Files:**
- Create: `egon-cola-xingyuan-admin-web-shared/src/auth/oauthClient.ts`
- Create: `egon-cola-xingyuan-admin-web-shared/src/auth/oauthClient.test.ts`
...
```bash
cd egon-cola-xingyuan-admin-web-shared && npx vitest run src/auth/oauthClient.test.ts
```
...
```bash
git add egon-cola-xingyuan-admin-web-shared/src/auth/oauthClient.ts egon-cola-xingyuan-admin-web-shared/src/auth/oauthClient.test.ts
...
**Files:**
- Create: `egon-cola-xingyuan-admin-web-shared/src/api/httpClient.ts`
- Create: `egon-cola-xingyuan-admin-web-shared/src/api/httpClient.test.ts`
...
```bash
cd egon-cola-xingyuan-admin-web-shared && npx vitest run src/api/httpClient.test.ts
```
...
```bash
git add egon-cola-xingyuan-admin-web-shared/src/api/httpClient.ts egon-cola-xingyuan-admin-web-shared/src/api/httpClient.test.ts
...
**Files:**
- Create: `egon-cola-xingyuan-admin-web-shared/src/i18n/zh-CN.ts`
- Create: `egon-cola-xingyuan-admin-web-shared/src/i18n/en-US.ts`
- Create: `egon-cola-xingyuan-admin-web-shared/src/i18n/index.ts`
...
```bash
git add egon-cola-xingyuan-admin-web-shared/src/i18n/
...
**Files:**
- Create: `egon-cola-xingyuan-admin-web-shared/src/components/PageState.tsx`
...
```bash
git add egon-cola-xingyuan-admin-web-shared/src/components/PageState.tsx
...
**Files:**
- Create: `egon-cola-xingyuan-admin-web-shared/src/components/AppErrorBoundary.tsx`
...
```bash
git add egon-cola-xingyuan-admin-web-shared/src/components/AppErrorBoundary.tsx
...
**Files:**
- Create: `egon-cola-xingyuan-admin-web-shared/src/components/PageTemplate.tsx`
...
```bash
git add egon-cola-xingyuan-admin-web-shared/src/components/PageTemplate.tsx
...
**Files:**
- Create: `egon-cola-xingyuan-admin-web-shared/src/hooks/usePermission.ts`
...
```bash
git add egon-cola-xingyuan-admin-web-shared/src/hooks/usePermission.ts
...
**Files:**
- Create: `egon-cola-xingyuan-admin-web-shared/src/index.ts`
...
```bash
cd egon-cola-xingyuan-admin-web-shared && npm run build
```

- [ ] **Step 3: Commit**

```bash
git add egon-cola-xingyuan-admin-web-shared/src/index.ts
...
```bash
cd egon-cola-tianquan-shoubing-admin-web
```
...
```bash
cd egon-cola-tianquan-shoubing-admin-web && npm install
```
...
import { AdminThemeProvider, injectTokens, initI18n } from '@egon-cola/xingyuan-admin-web-shared'
...
- Delete: `egon-cola-tianquan-shoubing-admin-web/src/auth/oauthClient.ts`
- Delete: `egon-cola-tianquan-shoubing-admin-web/src/auth/tokenStore.ts`
...
```bash
git rm egon-cola-tianquan-shoubing-admin-web/src/auth/oauthClient.ts
git rm egon-cola-tianquan-shoubing-admin-web/src/auth/tokenStore.ts
```
...
- Create: `egon-cola-tianquan-shoubing-admin-web/src/app/router.tsx`
...
import { usePermission } from '@egon-cola/xingyuan-admin-web-shared'
...
- Create: `egon-cola-tianquan-shoubing-admin-web/src/features/overview/OverviewPage.tsx`
...
- Create: `egon-cola-tianquan-shoubing-admin-web/src/features/users/UserListPage.tsx`
...
import { useAuth } from '../../auth/AuthContext'
import { usePermission, PageState } from '@egon-cola/xingyuan-admin-web-shared'
...
- Create: `egon-cola-tianquan-shoubing-admin-web/src/features/clients/ClientListPage.tsx`
...
- Create: `egon-cola-tianquan-shoubing-admin-web/src/features/keys/SigningKeyPage.tsx`
...
- Create: `egon-cola-tianquan-shoubing-admin-web/src/features/audits/AuditLogPage.tsx`
...
```bash
git rm egon-cola-tianquan-shoubing-admin-web/src/app/AdminConsole.tsx
cd egon-cola-tianquan-shoubing-admin-web && npm run build
```
...
// AFTER（1 行）
import { useFeatureQuery } from '@egon-cola/xingyuan-admin-web-shared'
...
```bash
git rm egon-cola-tianquan-jianshen-admin-web/src/features/tenant/TenantDetailPage.tsx
