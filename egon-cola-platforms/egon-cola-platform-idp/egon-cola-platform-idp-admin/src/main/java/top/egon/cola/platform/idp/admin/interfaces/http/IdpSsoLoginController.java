...
@RestController
public class IdpSsoLoginController {
    ...
    public ResponseEntity<LoginResponse> login(
        ...
        return ResponseEntity.ok()
                ...
                .header(HttpHeaders.CACHE_CONTROL, "no-store")
                .body(new LoginResponse(identity.identitySub(), identity.displayName(),
                        identity.mustChangePassword()));
    }

    @org.springframework.web.bind.annotation.ExceptionHandler(IdentityException.class)
    public ResponseEntity<LoginErrorResponse> authenticationFailed(
    ...
    public record LoginErrorResponse(String code, String message) {
    }
}
