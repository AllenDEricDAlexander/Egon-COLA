...
public final class IdpSsoSessionStore {
    ...
    public String create(String identitySub, Duration ttl) {
        ...
        String encoded = encode(new OAuthSsoSession(subject, sessionId));
    ...
    public Optional<OAuthSsoSession> resolve(String token) {
    ...
    private static String encode(OAuthSsoSession session) {
    ...
    private static OAuthSsoSession decode(String value) {
        try {
