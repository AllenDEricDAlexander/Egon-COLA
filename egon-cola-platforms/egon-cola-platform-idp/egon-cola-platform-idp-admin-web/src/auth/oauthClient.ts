...
const transactionKey = 'egon.idp.admin.oauth.transaction'
...
export const idpOAuth = createBrowserOAuthClient({
  issuer: import.meta.env.VITE_IDP_ISSUER ?? 'http://127.0.0.1:18120',
  clientId: import.meta.env.VITE_IDP_CLIENT_ID ?? 'idp-admin-web',
  audience: import.meta.env.VITE_IDP_AUDIENCE ?? 'idp-admin-web',
