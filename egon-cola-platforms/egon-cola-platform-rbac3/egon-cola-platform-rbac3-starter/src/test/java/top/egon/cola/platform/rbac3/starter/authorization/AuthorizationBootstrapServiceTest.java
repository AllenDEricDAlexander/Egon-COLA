...
class AuthorizationBootstrapServiceTest {
    ...
    void exposesOnlyBoundIdentityAndSystemSnapshotFacts() {
        ...
        IdentityPrincipal identity = new IdentityPrincipal(
                "alice-sub", "tenant-a", "sid-1", "gateway-admin-web",
        ...
        SystemAuthorizationSnapshot snapshot = new SystemAuthorizationSnapshot(
                "tenant-a", "alice-sub", "101", "sid-1", "gateway-admin",
                3, 4, 5, List.of("role-1"),
        ...
        assertThat(view.identitySub()).isEqualTo("alice-sub");
        assertThat(view.systemCode()).isEqualTo("gateway-admin");
        assertThat(view.permissions()).containsExactly(
                "gateway:groups:write", "gateway:read");
        assertThat(view.contextVersion()).isEqualTo(4);
    }
}
