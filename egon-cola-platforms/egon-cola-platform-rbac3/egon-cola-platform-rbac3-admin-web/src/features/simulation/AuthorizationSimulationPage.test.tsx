...
const wrapper = ({ children }: PropsWithChildren) => {
  const sdk = {
    ...
    getBootstrap: async () => ({
      user: { id: '7', tenantId: '9' }, sessionId: '11', authVersion: 2, sessionVersion: 3, policyVersion: 4,
  ...
  const api: FeatureApiClient = { request: async <T,>() => ({
    ...
    authVersion: 2, sessionVersion: 3, policyVersion: 4, snapshotChecksum: 'safe-checksum', expiresAt: '2026-08-01T01:00:00Z',
  }) as T }
