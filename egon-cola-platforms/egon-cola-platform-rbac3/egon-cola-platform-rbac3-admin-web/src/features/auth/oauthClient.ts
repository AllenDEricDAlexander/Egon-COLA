import { InMemoryAccessTokenStore } from '@egon-cola/rbac3-react-sdk'

export const rbac3AccessTokenStore = new InMemoryAccessTokenStore()
...
const transactionKey = 'egon.rbac3.admin.oauth.transaction'
...
export const createBrowserOAuthClient = (
  ...
  const storeToken = (response: TokenResponse, expectedNonce?: string): string => {
    ...
    rbac3AccessTokenStore.set(response.access_token)
    currentNonce = typeof claims.nonce === 'string' ? claims.nonce : undefined
