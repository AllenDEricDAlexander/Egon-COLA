package top.egon.cola.platform.rbac3.admin.authorization.policy.management.repository.jpa;
...
import top.egon.cola.platform.rbac3.admin.authorization.policy.management.domain.po.ManagementOperationPO;
import top.egon.cola.platform.rbac3.admin.authorization.policy.management.domain.po.ManagementPolicyPO;
import top.egon.cola.platform.rbac3.admin.authorization.policy.management.domain.po.ManagementRolePO;
...
import top.egon.cola.platform.rbac3.admin.authorization.policy.management.domain.dto.SavePolicyCommandDTO;
import top.egon.cola.platform.rbac3.admin.authorization.policy.management.domain.po.ManagementPolicySubjectPO;
import top.egon.cola.platform.rbac3.admin.authorization.policy.management.domain.po.ManagementPolicyScopePO;
import top.egon.cola.platform.rbac3.admin.authorization.grant.userrole.domain.enums.UserRoleAssignmentStatusEnum;
import top.egon.cola.platform.rbac3.admin.authorization.policy.management.repository.ManagementPolicyFactRepository;
import top.egon.cola.platform.rbac3.admin.authorization.policy.management.repository.ManagementPolicyControlRepository;
...
import top.egon.cola.platform.rbac3.admin.authorization.policy.management.domain.enums.ManagementOperationOperationEnum;
import top.egon.cola.platform.rbac3.admin.authorization.policy.management.domain.enums.ManagementPolicyStatusEnum;
import top.egon.cola.platform.rbac3.admin.authorization.policy.management.domain.enums.ManagementPolicyRiskLevelEnum;
import top.egon.cola.platform.rbac3.admin.authorization.policy.management.domain.enums.ManagementPolicyAuthenticationStrengthEnum;
import top.egon.cola.platform.rbac3.admin.authorization.policy.management.domain.enums.ManagementSubjectSubjectTypeEnum;
