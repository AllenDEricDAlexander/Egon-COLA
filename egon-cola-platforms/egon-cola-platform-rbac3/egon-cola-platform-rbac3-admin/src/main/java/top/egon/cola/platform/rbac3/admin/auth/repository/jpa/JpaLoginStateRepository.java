...
@Repository
public class JpaLoginStateRepository implements LoginStateDataRepository {
     ...
     */
    public JpaLoginStateRepository(EntityManager entityManager) {
    ...
    public LoginStateVO loadBase(String tenantCode, String userId, Instant now) {
