...
import top.egon.cola.platform.rbac3.admin.resource.domain.dto.SubmitManifestRequestDTO;
import top.egon.cola.platform.rbac3.admin.resource.domain.dto.ActivateManifestRequestDTO;
...
import top.egon.cola.platform.rbac3.admin.resource.domain.dto.ActivateCommandDTO;
import top.egon.cola.platform.rbac3.admin.resource.domain.vo.SubmissionResultVO;
import top.egon.cola.platform.rbac3.admin.resource.domain.vo.ActivationResultVO;
...
public class ManifestController {
    ...
    public ApiEnvelopeVO<SubmissionResultVO> submit(
            @Valid @RequestBody SubmitManifestRequestDTO request) {
        return ApiEnvelopeVO.success(manifestFacade.submit(new SubmitCommandDTO(
                tenantId(),
    ...
    @GatewayOperation(
            ...
            tags = {"rbac3", "resource-manifest"})
    public ApiEnvelopeVO<ManifestVO> manifest(
    ...
    @GatewayOperation(
            ...
            externalAccessible = true,
            tags = {"rbac3", "resource-manifest"})
    public ApiEnvelopeVO<ManifestValidationVO> validation(
            @PathVariable String manifestId) {
    ...
    @GatewayOperation(
            ...
            externalAccessible = true,
            tags = {"rbac3", "resource-manifest"})
    public ApiEnvelopeVO<ManifestImpactVO> impact(
            @PathVariable String manifestId) {
    ...
    @GatewayOperation(
            ...
            externalAccessible = true,
            tags = {"rbac3", "resource-manifest"})
    public ApiEnvelopeVO<ActivationResultVO> activate(
            @PathVariable String manifestId,
            @RequestHeader("If-Match") long expectedApplicationVersion,
            @RequestHeader("Idempotency-Key") String idempotencyKey,
            @Valid @RequestBody ActivateManifestRequestDTO request,
            @AuthenticationPrincipal CurrentRbac3Principal principal) {
        return ApiEnvelopeVO.success(manifestFacade.activate(new ActivateCommandDTO(
                tenantId(),
                request.applicationId(),
                manifestId,
