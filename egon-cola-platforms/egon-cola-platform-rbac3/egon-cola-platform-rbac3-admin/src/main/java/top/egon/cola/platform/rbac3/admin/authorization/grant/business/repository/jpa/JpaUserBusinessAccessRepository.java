package top.egon.cola.platform.rbac3.admin.authorization.grant.business.repository.jpa;
...
import top.egon.cola.platform.rbac3.admin.authorization.grant.business.domain.po.UserBusinessAccessPO;
...
public class JpaUserBusinessAccessRepository
    ...
    public List<UserApplicationAccessVO> applicationAccesses(
        ...
        return entityManager.createQuery("""
                ...
                .setParameter("assignmentStatus", top.egon.cola.platform.rbac3.admin.authorization.grant.userrole.domain.enums.UserRoleAssignmentStatusEnum.ACTIVE)
