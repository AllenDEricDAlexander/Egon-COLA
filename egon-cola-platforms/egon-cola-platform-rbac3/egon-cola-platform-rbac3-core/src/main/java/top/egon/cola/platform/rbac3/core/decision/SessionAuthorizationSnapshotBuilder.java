...
public final class SessionAuthorizationSnapshotBuilder {

    public static final int MAX_ROLE_FAMILY_PER_ROOT = 2048;
    public static final int MAX_SESSION_PERMISSIONS = 16_384;
    public static final int MAX_SESSION_RESOURCES = 50_000;
    ...
    public ActivationAuthorizationSnapshot build(
        ...
        if (permissions.size() > MAX_SESSION_PERMISSIONS) {
            throw new Rbac3RuleViolation("ROLE_FAMILY_SIZE_LIMIT_EXCEEDED");
        }
        ...
        if (resources.size() > MAX_SESSION_RESOURCES) {
            throw new Rbac3RuleViolation("ROLE_FAMILY_SIZE_LIMIT_EXCEEDED");
        }
        ...
        String canonical = canonical(rootRoleIds, effectiveRoleIds, permissions,
                ...
                authVersion, nextSessionVersion, policyVersion);
        ...
        return new ActivationAuthorizationSnapshot(
                ...
                landingRoute, authVersion, nextSessionVersion, policyVersion,
