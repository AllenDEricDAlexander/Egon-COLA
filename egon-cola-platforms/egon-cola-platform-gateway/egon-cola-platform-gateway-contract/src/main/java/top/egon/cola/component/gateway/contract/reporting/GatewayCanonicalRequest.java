...
/**
 * 构造 Gateway HTTP HMAC 协议使用的确定性请求表示。
 * Builds the deterministic request representation used by Gateway HTTP HMAC.
 */
public final class GatewayCanonicalRequest {
    ...
    public GatewayCanonicalRequest(
            String method,
            String path,
        ...
        this.canonicalQuery = canonicalizeQuery(
    ...
    private static String canonicalizeQuery(
            Map<String, ? extends Collection<String>> query) {
