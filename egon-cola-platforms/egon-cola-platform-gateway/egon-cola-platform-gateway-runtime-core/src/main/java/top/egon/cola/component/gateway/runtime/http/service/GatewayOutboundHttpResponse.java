package top.egon.cola.component.gateway.runtime.http.service;
...
public final class GatewayOutboundHttpResponse {
     ...
     */
    public GatewayOutboundHttpResponse withBody(Flux<DataBuffer> replacement) {
     ...
     */
    public GatewayOutboundHttpResponse onAbandon(Runnable action) {
