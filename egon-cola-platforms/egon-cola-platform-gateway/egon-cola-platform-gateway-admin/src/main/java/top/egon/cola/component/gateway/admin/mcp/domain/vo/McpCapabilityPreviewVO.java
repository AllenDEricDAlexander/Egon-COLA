...
public record McpCapabilityPreviewVO(
        /**
         * 中文说明：保存 content 对应的状态、依赖或配置值；字段类型为 {@code McpRuleContent}，由 {@code top.egon.cola.component.gateway.admin.mcp.domain.vo.McpCapabilityPreviewVO} 在其生命周期内读取或更新。
         * English summary: Holds the state, dependency, or configuration represented by content; its type is {@code McpRuleContent}, and {@code top.egon.cola.component.gateway.admin.mcp.domain.vo.McpCapabilityPreviewVO} reads or updates it during its lifecycle.
         *
         * 用法 / Usage: 该字段通过 {@code top.egon.cola.component.gateway.admin.mcp.domain.vo.McpCapabilityPreviewVO} 的构造、初始化或业务方法使用；/ Access it through the construction, initialization, or business methods of {@code top.egon.cola.component.gateway.admin.mcp.domain.vo.McpCapabilityPreviewVO}; do not couple callers to its representation when the owning type exposes an API.
         */
        McpRuleContent content,
        /**
         * 中文说明：保存 validation 对应的状态、依赖或配置值；字段类型为 {@code top.egon.cola.component.gateway.admin.mcp.domain.vo.McpValidationReportVO}，由 {@code top.egon.cola.component.gateway.admin.mcp.domain.vo.McpCapabilityPreviewVO} 在其生命周期内读取或更新。
         * English summary: Holds the state, dependency, or configuration represented by validation; its type is {@code top.egon.cola.component.gateway.admin.mcp.domain.vo.McpValidationReportVO}, and {@code top.egon.cola.component.gateway.admin.mcp.domain.vo.McpCapabilityPreviewVO} reads or updates it during its lifecycle.
         *
         * 用法 / Usage: 该字段通过 {@code top.egon.cola.component.gateway.admin.mcp.domain.vo.McpCapabilityPreviewVO} 的构造、初始化或业务方法使用；/ Access it through the construction, initialization, or business methods of {@code top.egon.cola.component.gateway.admin.mcp.domain.vo.McpCapabilityPreviewVO}; do not couple callers to its representation when the owning type exposes an API.
         */
        top.egon.cola.component.gateway.admin.mcp.domain.vo.McpValidationReportVO validation
) {
}
