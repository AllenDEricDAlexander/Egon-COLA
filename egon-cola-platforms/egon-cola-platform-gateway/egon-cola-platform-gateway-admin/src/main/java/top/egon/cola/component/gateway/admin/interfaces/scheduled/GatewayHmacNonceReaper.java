...
public class GatewayHmacNonceReaper {
    ...
    /**
     * 中文说明：保存 nonces 对应的状态、依赖或配置值；字段类型为 {@code GatewayHmacNonceStore}，由 {@code GatewayHmacNonceReaper} 在其生命周期内读取或更新。
     * English summary: Holds the state, dependency, or configuration represented by nonces; its type is {@code GatewayHmacNonceStore}, and {@code GatewayHmacNonceReaper} reads or updates it during its lifecycle.
     *
