...
import top.egon.cola.component.gateway.admin.credential.domain.dto.GatewayCredentialRotateRequestDTO;
...
public class GatewayCredentialController {
    ...
    public top.egon.cola.component.gateway.admin.credential.domain.vo.IssuedGatewayCredentialVO create(
            @PathVariable String applicationId,
            AdminActor actor) {
    ...
    @ResponseStatus(HttpStatus.CREATED)
    @PreAuthorize("hasAnyAuthority('CAP_gateway:credentials:write','CAP_*')")
    public top.egon.cola.component.gateway.admin.credential.domain.vo.IssuedGatewayCredentialVO rotate(
            @PathVariable String applicationId,
