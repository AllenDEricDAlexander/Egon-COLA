package top.egon.cola.component.gateway.admin.openapi.controller;

import org.junit.jupiter.api.Test;
import org.springframework.test.web.servlet.MockMvc;
import org.springframework.test.web.servlet.setup.MockMvcBuilders;
import top.egon.cola.component.gateway.admin.openapi.domain.vo.GatewayOpenApiDocumentVO;
import top.egon.cola.component.gateway.admin.openapi.domain.vo.GatewayOpenApiSyncStateVO;
import top.egon.cola.component.gateway.admin.openapi.domain.vo.GatewayOperationOpenApiVO;
import top.egon.cola.component.gateway.admin.openapi.service.GatewayOpenApiQueryService;
...
class GatewayOpenApiControllerTest {
    ...
    void mapsMissingReadResourceThroughExistingAdminAdvice() throws Exception {
        ...
        when(service.getSnapshotDocument("missing"))
                .thenThrow(new top.egon.cola.component.gateway.admin.shared.domain.exception.GatewayAdminNotFoundException(
    ...
    void mapsUnavailableOpenApiSourceToConflict() throws Exception {
        ...
        when(service.getOperationOpenApi("rpc-operation"))
                .thenThrow(new top.egon.cola.component.gateway.admin.shared.domain.exception.GatewayOpenApiSourceNotAvailableException());
        MockMvc mvc = MockMvcBuilders.standaloneSetup(
                        new GatewayOpenApiController(service))
                .setControllerAdvice(new GatewayAdminExceptionHandler())
                .build();
