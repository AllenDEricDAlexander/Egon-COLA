...
import top.egon.cola.component.gateway.admin.openapi.validation.GatewayOpenApiValidationChain;
...
class GatewayOpenApiSyncServiceTest {
    ...
    void freshDdcManifestDiscoversAllGroupsAndIngestsOneAggregate() {
        ...
        top.egon.cola.component.ddc.api.client.DdcManagementClient ddc =
                mock(top.egon.cola.component.ddc.api.client.DdcManagementClient.class);
