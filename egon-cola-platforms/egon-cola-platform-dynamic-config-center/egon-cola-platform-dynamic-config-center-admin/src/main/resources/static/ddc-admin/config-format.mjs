...
const jsonValue = (value) => {
  try {
    ...
    throw new Error('JSON 配置格式无效，请检查括号、逗号和引号')
  }
}

const isObject = (value) => value !== null && typeof value === 'object' && !Array.isArray(value)

const gatewayInlineRule = (value) => {
...
export const prepareConfigEditor = (config = {}) => {
...
export const serializeConfigEditor = async (editor, content) => {
