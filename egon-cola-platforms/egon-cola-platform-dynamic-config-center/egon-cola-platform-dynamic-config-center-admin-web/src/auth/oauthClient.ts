...
const transactionKey = 'egon.ddc.admin.oauth.transaction'
...
export const ddcOAuth = createBrowserOAuthClient({
  issuer: import.meta.env.VITE_IDP_ISSUER ?? 'http://127.0.0.1:18120',
  clientId: import.meta.env.VITE_IDP_CLIENT_ID ?? 'ddc-admin-web',
  audience: import.meta.env.VITE_IDP_AUDIENCE ?? 'ddc-admin-web',
