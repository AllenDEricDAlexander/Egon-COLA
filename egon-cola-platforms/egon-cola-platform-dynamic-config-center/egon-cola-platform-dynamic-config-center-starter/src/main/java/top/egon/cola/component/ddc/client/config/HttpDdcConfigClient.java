 ...
 */
public class HttpDdcConfigClient implements DdcConfigClient {
     ...
     */
    public HttpDdcConfigClient(DdcProperties properties) {
     ...
     */
    HttpDdcConfigClient(DdcProperties properties, RestClient.Builder restClientBuilder) {
