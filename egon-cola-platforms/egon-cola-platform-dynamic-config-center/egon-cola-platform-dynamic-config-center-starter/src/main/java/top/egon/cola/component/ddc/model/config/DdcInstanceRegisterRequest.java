...
/**
 * 配置客户端实例向 Admin 发起的注册请求。
 * / Registration request sent by a configuration client instance to Admin.
 */
public class DdcInstanceRegisterRequest {
    ...
    /**
     * 返回租约有效期秒数。 / Returns the lease duration in seconds.
     *
     * @return 租约秒数 / lease duration in seconds
     */
    ...
    /**
     * 设置租约有效期秒数。 / Sets the lease duration in seconds.
     *
     * @param leaseSeconds 租约秒数 / lease duration in seconds
     */
    ...
    /**
     * 返回注册 SERVICE Token。 / Returns the registration SERVICE token.
     *
    ...
    /**
     * 设置注册 SERVICE Token。 / Sets the registration SERVICE token.
     *
