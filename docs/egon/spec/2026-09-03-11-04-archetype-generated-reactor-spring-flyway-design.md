...
|-------------|------------------------------------------|--------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------|------------------------------|
| EVD-001     | Static repository                        | pom.xml modules                                                                                  | 根 Reactor 聚合 components、platforms、archetypes                                                                                                                          | 发布需保持根级单 Reactor 边界                  | 不证明 Central 远端状态             |
...
| EVD-009     | Static repository                        | pom.xml, egon-cola-components/pom.xml, egon-cola-platforms/pom.xml, egon-cola-archetypes/pom.xml | 根 POM 未导入 Boot BOM；三个一级子 Parent 分别重复声明 Boot 版本和 BOM                                                                                                                   | 版本治理应上移根 Parent                      | 不代表所有独立 IT POM 自动继承          |
