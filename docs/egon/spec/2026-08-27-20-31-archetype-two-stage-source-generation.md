...
| Baseline Revision  | `main@907e0a26e756d94390e3ae579ebd4306cccc9381；2026-08-27 20:31 CST dirty-worktree snapshot：RBAC3 bootstrap 两个 Java/Test 文件及 scripts/unified-identity-local.sh、scripts/unified-xingyuan/test-direct-run-contract.sh 存在并发修改，本 Spec 不覆盖、不回退`                                                                                                                                                                                                                                                           |
