...
| Content type/version     | Java types at the same reactor version; snapshot release/version/checksum is the data version                                                                                    |
...
| Output       | Non-null immutable `ApiRpcGatewayCompiledRulesDTO` or `McpGatewayCompiledRulesDTO`; release/version/checksum identity must equal the input snapshot identity.                                                    |
...
| `GatewayCompiledRulesDTO.ruleVersion`                  | `long`                                               | Required                                                   | Existing positive/ordered rule version invariant                                                                                | Snapshot/compiler      | `REQ-004`,`REQ-006`           |
