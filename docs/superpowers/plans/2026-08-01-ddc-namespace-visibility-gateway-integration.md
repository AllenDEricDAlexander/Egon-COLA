# Tianshu Namespace Visibility and Yuheng Integration Implementation Plan
...
**Goal:** 将 Tianshu 改成 `biz -> namespace -> env -> app` 管控可见性模型，同时让物理配置和服务注册只保留 `biz + env + app` 身份，统一副本实例 ID，并完成 Yuheng Admin、Yuheng Engine 与两个订单服务副本的本机联调。

**Architecture:** namespace 是 biz 下的管理实体，`DdcNamespaceEnvAppBindingEntity` 作为 Association Object 保存环境级应用可见性；配置、服务、实例租约不复制。服务注册采用 V3 canonical/serviceId、V3 Redis scope/global catalog，配置采用 V3 Redis scope；`DdcInstanceIdProvider` Strategy 统一实例身份。Tianshu Admin 提供可选筛选和 binding 级联，两个 Web UI 只消费这些稳定接口。
...
- 只新增 Tianshu `V7` 迁移版本；PostgreSQL 与 SQLite 各一份同版本方言文件，绝不修改 V1-V6。
...
- `serviceId = SHA-256(serviceKey.canonicalValue())`；canonical 首行固定为 `tianshu-service-key-v3`，字段禁止 CR/LF。
- `instanceId` 优先级为显式 `egon.cola.component.tianshu.instance.id`、自定义 `DdcInstanceIdProvider`、完整 UUIDv7；不使用 MAC/IP/PID Hash。
- `leaseId` 继续由 Tianshu Admin 为每次成功注册生成 UUIDv7，并保持 fencing 语义。
...
- 最终验收后保持 Tianshu Admin/Web、Yuheng Admin/Web/Engine 和两个订单 Provider 运行，供用户测试。
...
**Files:**
- Create: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-starter/src/main/java/top/egon/cola/component/tianshu/service/DdcInstanceIdProvider.java`
- Modify: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-starter/src/main/java/top/egon/cola/component/tianshu/model/registry/DdcServiceKey.java`
- Modify: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-starter/src/main/java/top/egon/cola/component/tianshu/model/registry/DdcServiceQuery.java`
...
- Modify: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-starter/src/main/java/top/egon/cola/component/tianshu/config/DdcProperties.java`
- Modify: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-starter/src/main/java/top/egon/cola/component/tianshu/config/DdcAutoConfig.java`
- Modify: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-starter/src/main/java/top/egon/cola/component/tianshu/service/DdcInstanceIdentityFactory.java`
- Modify: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-starter/src/main/java/top/egon/cola/component/tianshu/common/DdcKeys.java`
- Test: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-starter/src/test/java/top/egon/cola/component/tianshu/model/registry/DdcServiceRegistrationTest.java`
- Test: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-starter/src/test/java/top/egon/cola/component/tianshu/registry/DdcServiceKeyFactoryTest.java`
- Create test: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-starter/src/test/java/top/egon/cola/component/tianshu/service/DdcInstanceIdentityFactoryTest.java`
- Modify test: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-starter/src/test/java/top/egon/cola/component/tianshu/common/DdcKeysTest.java`
- Modify test: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-starter/src/test/java/top/egon/cola/component/tianshu/config/DdcAutoConfigTest.java`
...
void derivesOneServiceIdForReplicasWithoutNamespace() {
    ...
    assertThat(key.canonicalValue()).isEqualTo(String.join("\n",
            "tianshu-service-key-v3", "retail", "local", "order",
...
public record DdcServiceKey(
    ...
    public String canonicalValue() {
        return String.join("\n", "tianshu-service-key-v3", bizCode, env, appCode,
...
git commit -m "feat(tianshu): introduce v3 service and instance identity"
```

### Task 2: 将服务注册、目录和所有运行时迁移到 V3

**Files:**
- Modify: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-starter/src/main/java/top/egon/cola/component/tianshu/model/dto/DdcServiceLeaseRequest.java`
- Modify: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-starter/src/main/java/top/egon/cola/component/tianshu/registry/DdcOpenApiServiceRegistryClient.java`
- Modify: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-starter/src/main/java/top/egon/cola/component/tianshu/registry/DdcRegistrySubscriptionManager.java`
- Modify: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-admin/src/main/java/top/egon/cola/component/tianshu/admin/repository/DdcServiceRegistryRedisRepository.java`
- Modify: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-admin/src/main/java/top/egon/cola/component/tianshu/admin/service/DdcServiceRegistryService.java`
- Modify: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-admin/src/main/java/top/egon/cola/component/tianshu/admin/controller/DdcRegistryOpenApiController.java`
...
- Modify: `egon-cola-xingyuan/egon-cola-yuheng/yuheng-provider-runtime/src/main/java/top/egon/cola/component/yuheng/provider/GatewayHttpProviderProperties.java`
- Modify: `egon-cola-xingyuan/egon-cola-yuheng/yuheng-provider-runtime/src/main/java/top/egon/cola/component/yuheng/provider/HttpProviderRuntimeProperties.java`
...
- Modify: `egon-cola-xingyuan/egon-cola-yuheng/yuheng-biz-gateway/src/main/java/top/egon/cola/component/yuheng/engine/rpc/RpcGatewaySlotProperties.java`
...
- Test: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-admin/src/test/java/top/egon/cola/component/tianshu/admin/repository/DdcServiceRegistryRedisRepositoryTest.java`
- Test: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-admin/src/test/java/top/egon/cola/component/tianshu/admin/service/DdcServiceRegistryServiceTest.java`
- Test: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-admin/src/test/java/top/egon/cola/component/tianshu/admin/controller/DdcRegistryOpenApiControllerTest.java`
...
- Test: `egon-cola-xingyuan/egon-cola-yuheng/yuheng-provider-runtime/src/test/java/top/egon/cola/component/yuheng/provider/HttpProviderLeaseRuntimeTest.java`
- Test: `egon-cola-xingyuan/egon-cola-yuheng/yuheng-biz-gateway/src/test/java/top/egon/cola/component/yuheng/engine/rpc/RpcGatewaySlotRuntimeTest.java`
...
- RPC Provider, HTTP Provider and Yuheng Engine use the shared Tianshu instance ID and no longer pass namespace to `DdcServiceKeyFactory`.
...
- [ ] **Step 4: 迁移 RPC、HTTP Provider 和 Yuheng Engine 的调用点**
...
- [ ] **Step 5: 运行 Tianshu/RPC/Yuheng GREEN 测试并提交**
...
git commit -m "feat(tianshu): migrate service registry runtimes to v3"
```
...
- Create: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-admin/src/test/java/top/egon/cola/component/tianshu/admin/repository/DdcV7MigrationTest.java`
- Modify: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-admin/src/main/java/top/egon/cola/component/tianshu/admin/model/entity/DdcAppEntity.java`
- Modify: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-admin/src/main/java/top/egon/cola/component/tianshu/admin/model/entity/DdcNamespaceEntity.java`
- Create: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-admin/src/main/java/top/egon/cola/component/tianshu/admin/model/entity/DdcNamespaceEnvAppBindingEntity.java`
...
- Create: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-admin/src/main/java/top/egon/cola/component/tianshu/admin/repository/DdcNamespaceEnvAppBindingRepository.java`
- Create: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-admin/src/main/java/top/egon/cola/component/tianshu/admin/model/dto/DdcNamespaceEnvAppBindingRequest.java`
- Create: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-admin/src/main/java/top/egon/cola/component/tianshu/admin/model/vo/DdcNamespaceEnvAppBindingVO.java`
- Modify: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-admin/src/main/java/top/egon/cola/component/tianshu/admin/service/DdcAppService.java`
- Modify: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-admin/src/main/java/top/egon/cola/component/tianshu/admin/service/DdcNamespaceService.java`
- Create: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-admin/src/main/java/top/egon/cola/component/tianshu/admin/service/DdcNamespaceEnvAppBindingService.java`
- Modify: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-admin/src/main/java/top/egon/cola/component/tianshu/admin/service/DdcEnvService.java`
- Modify: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-admin/src/main/java/top/egon/cola/component/tianshu/admin/controller/DdcAppController.java`
- Modify: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-admin/src/main/java/top/egon/cola/component/tianshu/admin/controller/DdcNamespaceController.java`
- Create: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-admin/src/main/java/top/egon/cola/component/tianshu/admin/controller/DdcNamespaceEnvAppBindingController.java`
- Modify: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-admin/src/main/java/top/egon/cola/component/tianshu/admin/controller/DdcEnvController.java`
- Modify: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-starter/src/main/java/top/egon/cola/component/tianshu/common/DdcErrorStatus.java`
- Test: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-admin/src/test/java/top/egon/cola/component/tianshu/admin/controller/DdcAppControllerTest.java`
- Test: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-admin/src/test/java/top/egon/cola/component/tianshu/admin/controller/DdcNamespaceControllerTest.java`
- Create test: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-admin/src/test/java/top/egon/cola/component/tianshu/admin/controller/DdcNamespaceEnvAppBindingControllerTest.java`
...
- `GET /api/v1/tianshu/namespaces?bizCode=&keyword=` lists namespaces by biz.
- `GET /api/v1/tianshu/envs?bizCode=&namespaceCode=&keyword=` returns bound envs when biz+namespace are present and global envs otherwise.
- `GET /api/v1/tianshu/apps?bizCode=&namespaceCode=&env=&keyword=` returns bound apps when namespace+env are present and biz apps otherwise.
- Binding CRUD path is `/api/v1/tianshu/namespace-env-app-bindings`; app/namespace mutation paths use immutable entity ID.
...
新增状态码 `56043/TIANSHU_NAMESPACE_BINDING_EXISTS`、`56044/TIANSHU_NAMESPACE_BINDING_NOT_FOUND`。删除 namespace 时只检查 binding；删除 binding 不删除 app、配置、实例或 Redis 注册。
...
./mvnw -B -ntp -f egon-cola-xingyuan/egon-cola-tianshu/pom.xml \
  ...
  -Dsurefire.failIfNoSpecifiedTests=false test
git add egon-cola-xingyuan/egon-cola-tianshu
git commit -m "feat(tianshu-admin): add namespace environment app bindings"
```

### Task 4: 将 Starter 配置协议迁移到 biz-env-app V3

**Files:**
- Modify: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-starter/src/main/java/top/egon/cola/component/tianshu/model/vo/DdcInstanceIdentity.java`
- Modify: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-starter/src/main/java/top/egon/cola/component/tianshu/model/dto/DdcDefaultReportRequest.java`
- Modify: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-starter/src/main/java/top/egon/cola/component/tianshu/model/dto/DdcInstanceRegisterRequest.java`
- Modify: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-starter/src/main/java/top/egon/cola/component/tianshu/model/dto/DdcHeartbeatRequest.java`
- Modify: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-starter/src/main/java/top/egon/cola/component/tianshu/model/dto/DdcAckRequest.java`
- Modify: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-starter/src/main/java/top/egon/cola/component/tianshu/model/dto/DdcPublishMessage.java`
- Modify: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-starter/src/main/java/top/egon/cola/component/tianshu/client/HttpDdcAdminClient.java`
- Modify: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-starter/src/main/java/top/egon/cola/component/tianshu/repository/DdcRedisConfigRepository.java`
- Modify: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-starter/src/main/java/top/egon/cola/component/tianshu/listener/DdcRedisChangeListener.java`
- Modify: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-starter/src/main/java/top/egon/cola/component/tianshu/config/DdcAutoConfig.java`
- Modify: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-starter/src/main/java/top/egon/cola/component/tianshu/service/DdcInstanceService.java`
- Modify: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-starter/src/main/java/top/egon/cola/component/tianshu/service/DdcRuntimeCoordinator.java`
- Modify: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-starter/src/main/java/top/egon/cola/component/tianshu/service/DdcAckDelivery.java`
- Modify: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-starter/src/main/java/top/egon/cola/component/tianshu/management/model/DdcManagementConfigQuery.java`
- Modify: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-starter/src/main/java/top/egon/cola/component/tianshu/management/model/DdcManagementConfig.java`
- Modify: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-starter/src/main/java/top/egon/cola/component/tianshu/management/model/DdcManagementConfigUpsertRequest.java`
- Modify: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-starter/src/main/java/top/egon/cola/component/tianshu/management/model/DdcManagementConfigDeleteRequest.java`
- Modify: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-starter/src/main/java/top/egon/cola/component/tianshu/management/model/DdcManagementPublishRequest.java`
- Modify: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-starter/src/main/java/top/egon/cola/component/tianshu/management/model/DdcManagementInstanceQuery.java`
- Modify: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-starter/src/main/java/top/egon/cola/component/tianshu/management/model/DdcManagementConfigClientInstance.java`
...
- Test: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-starter/src/test/java/top/egon/cola/component/tianshu/client/HttpDdcAdminClientTest.java`
- Test: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-starter/src/test/java/top/egon/cola/component/tianshu/repository/DdcRedisConfigRepositoryTest.java`
- Test: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-starter/src/test/java/top/egon/cola/component/tianshu/service/DdcRuntimeCoordinatorTest.java`
...
./mvnw -B -ntp -f egon-cola-xingyuan/egon-cola-tianshu/pom.xml \
  -pl egon-cola-tianshu-starter -am clean test
git add egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-starter
git commit -m "refactor(tianshu): use physical biz env app config scope"
```

### Task 5: 迁移 Tianshu Admin 配置、发布、租约和可选筛选

**Files:**
- Modify entities: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-admin/src/main/java/top/egon/cola/component/tianshu/admin/model/entity/DdcConfigItemEntity.java`, `DdcConfigVersionEntity.java`, `DdcPublishTaskEntity.java`, `DdcPublishAckEntity.java`, `DdcInstanceEntity.java`, `DdcOperationLogEntity.java`
- Modify DTO/VO: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-admin/src/main/java/top/egon/cola/component/tianshu/admin/model/dto/DdcConfigCreateRequest.java`, `DdcConfigQueryRequest.java`, `DdcPublishRequest.java`, `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-admin/src/main/java/top/egon/cola/component/tianshu/admin/model/vo/DdcConfigResourceKey.java`, `DdcAtomicPublishCommand.java`, `DdcConfigVO.java`
- Modify repositories: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-admin/src/main/java/top/egon/cola/component/tianshu/admin/repository/DdcConfigItemRepository.java`, `DdcConfigVersionRepository.java`, `DdcInstanceRepository.java`, `DdcConfigLeaseRedisRepository.java`, `DdcRedisRepository.java`, `DdcPublishTaskRepository.java`
- Modify services: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-admin/src/main/java/top/egon/cola/component/tianshu/admin/service/DdcConfigService.java`, `DdcConfigLeaseService.java`, `DdcInstanceAdminService.java`, `DdcScopeGate.java`, `DdcCacheService.java`, `DdcPublishService.java`, `DdcPendingPublishDispatcher.java`, `DdcPublishStateTransitionService.java`, `PublishFailureRecorder.java`
- Modify controllers/facade: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-admin/src/main/java/top/egon/cola/component/tianshu/admin/controller/DdcConfigController.java`, `DdcOpenApiController.java`, `DdcManagementOpenApiController.java`, `DdcRegistryAdminController.java`, `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-admin/src/main/java/top/egon/cola/component/tianshu/admin/service/DdcManagementFacade.java`
- Modify error handling: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-admin/src/main/java/top/egon/cola/component/tianshu/admin/config/DdcGlobalExceptionHandler.java`
- Modify management service models: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-starter/src/main/java/top/egon/cola/component/tianshu/management/model/DdcManagementServiceKey.java`, `DdcManagementServiceQuery.java`
- Tests: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-admin/src/test/java/top/egon/cola/component/tianshu/admin/service/DdcConfigServiceTest.java`, `DdcScopeGateTest.java`, `DdcPublishPreparationTest.java`, `DdcPublishRetryTest.java`, `DdcAckServiceTest.java`
- Tests: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-admin/src/test/java/top/egon/cola/component/tianshu/admin/controller/DdcConfigControllerTest.java`, `DdcRegistryAdminControllerTest.java`, `DdcManagementOpenApiControllerTest.java`
- Test: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-admin/src/test/java/top/egon/cola/component/tianshu/admin/config/DdcGlobalExceptionHandlerTest.java`
- Test: `egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-admin/src/test/java/top/egon/cola/component/tianshu/admin/integration/DdcSyncPublishFlowTest.java`
...
- MVC binding/enum/body errors map to `TIANSHU_INVALID_REQUEST`, not `TIANSHU_INTERNAL_FAILURE`.
...
void listsAllConfigsWhenEveryFilterIsMissing() {
    ...
    when(repository.search(null, null, null, null, null, false))
            .thenReturn(List.of(config("infra", "local", "ge", "yuheng.rules.active")));
...
```bash
git add egon-cola-xingyuan/egon-cola-tianshu
git commit -m "fix(tianshu-admin): use physical scopes and optional filters"
```

### Task 6: 重构 Tianshu Web 为 biz-namespace-env-app 浏览
...
it('loads biz then namespace then env then app', async () => {
  ...
  expect(fetchMock).toHaveFetched('/api/v1/tianshu/namespaces?bizCode=infra')
  expect(fetchMock).toHaveFetched('/api/v1/tianshu/envs?bizCode=infra&namespaceCode=default')
  expect(fetchMock).toHaveFetched('/api/v1/tianshu/apps?bizCode=infra&namespaceCode=default&env=local')
})
...
const namespacePath = buildPath('/api/v1/tianshu/namespaces', { bizCode })
const envPath = buildPath('/api/v1/tianshu/envs', { bizCode, namespaceCode })
const appPath = buildPath('/api/v1/tianshu/apps', { bizCode, namespaceCode, env })
```
...
git commit -m "feat(tianshu-web): browse namespace visibility bindings"
```

### Task 7: 简化 Yuheng Web 本地 Access Token 登录
...
**Interfaces:**
- Produces `oauthRefreshEnabled = Boolean(VITE_YUHENG_ADMIN_TOKEN_URL && VITE_YUHENG_ADMIN_CLIENT_ID)`.
...
export const oauthRefreshEnabled = Boolean(
  import.meta.env.VITE_YUHENG_ADMIN_TOKEN_URL
  && import.meta.env.VITE_YUHENG_ADMIN_CLIENT_ID,
)
```

只有 `oauthRefreshEnabled` 为 true 时渲染 Refresh Token Form.Item；否则显示本地说明并调用 `auth.login({ accessToken }, remember)`。

- [ ] **Step 4: 运行 Yuheng Web 全量验证并提交**
...
git commit -m "fix(yuheng-web): simplify local token login"
```

### Task 8: 注册 Yuheng Admin=infra/ga 与 Engine=infra/ge
...
- Modify: `egon-cola-xingyuan/egon-cola-yuheng/yuheng-admin/src/main/java/top/egon/cola/component/yuheng/admin/GatewayAdminConfiguration.java`
- Modify: `egon-cola-xingyuan/egon-cola-yuheng/yuheng-admin/src/main/java/top/egon/cola/component/yuheng/admin/rule/GatewayDdcPublicationCommand.java`
- Modify: `egon-cola-xingyuan/egon-cola-yuheng/yuheng-admin/src/main/java/top/egon/cola/component/yuheng/admin/rule/GatewayDdcRulePublisher.java`
- Modify: `egon-cola-xingyuan/egon-cola-yuheng/yuheng-admin/src/main/java/top/egon/cola/component/yuheng/admin/application/release/GatewayReleasePublicationCoordinator.java`
...
- Test: `egon-cola-xingyuan/egon-cola-yuheng/yuheng-admin/src/test/java/top/egon/cola/component/yuheng/admin/GatewayAdminApplicationConfigurationTest.java`
- Test: `egon-cola-xingyuan/egon-cola-yuheng/yuheng-admin/src/test/java/top/egon/cola/component/yuheng/admin/rule/GatewayDdcRulePublisherTest.java`
- Test: `egon-cola-xingyuan/egon-cola-yuheng/yuheng-biz-gateway/src/test/java/top/egon/cola/component/yuheng/engine/GatewayEngineConfigurationTest.java`
- Test: `egon-cola-xingyuan/egon-cola-yuheng/yuheng-test/yuheng-test-suite/src/test/java/top/egon/cola/component/yuheng/test/live/GatewayLiveTopologyEngineLeaseTest.java`

**Interfaces:**
- Yuheng Admin adds the existing `yuheng-provider-runtime` module dependency; no new external dependency.
- Yuheng Admin local Tianshu identity is `infra/local/ga`; HTTP service is `egon-cola-yuheng-admin`, kind `HTTP_PROVIDER`, metadata `yuheng.component=admin`.
- Yuheng Engine local Tianshu identity is `infra/local/ge`; RPC service is `egon-yuheng-rpc`, kind `INTERNAL_GATEWAY`, metadata includes `yuheng.component=engine`.
- Yuheng Admin release publication target is configured separately as `yuheng.admin.tianshu.target-biz-code=infra`, `target-app-code=ge`; namespace from Yuheng rule content is not used as Tianshu config identity.
...
Expected: FAIL because Admin lacks provider-runtime self-registration and publication still derives app/namespace from Yuheng group scope.
...
egon:
  cola:
    component:
      tianshu:
        biz-code: ${TIANSHU_BIZ_CODE:infra}
        env: ${TIANSHU_ENV:local}
        app-code: ${TIANSHU_APP_CODE:ga}
        registry:
          enabled: ${TIANSHU_REGISTRY_ENABLED:false}
      yuheng:
        provider:
          http:
            enabled: ${YUHENG_ADMIN_TIANSHU_REGISTRATION_ENABLED:false}
            service-name: egon-cola-yuheng-admin
            metadata:
              yuheng.component: admin
```

Engine application.yml 使用 `TIANSHU_APP_CODE:ge`；本机运行命令显式启用 Tianshu 和 registry。`GatewayReleasePublicationCoordinator.Scope` 改为 `(bizCode, env, appCode)`，值来自 target properties 和 compiled env。

- [ ] **Step 4: 运行 Yuheng 全 reactor GREEN 并提交**

```bash
./mvnw -B -ntp -f egon-cola-xingyuan/egon-cola-yuheng/pom.xml clean test
git add egon-cola-xingyuan/egon-cola-yuheng
git commit -m "feat(yuheng): register admin and engine with tianshu"
```
...
- Yuheng Engine public/internal/management/RPC ports: `18081/18082/18083/19090`.
...
预检查必须返回 0 行才启动新 Tianshu Admin。使用已有受控本机连接配置执行 Flyway；不在命令行回显密码。迁移后查询 Flyway history、V7 表/索引和旧数据行数。
...
依次启动 Tianshu Admin、创建 biz/env/app/namespace/binding、Yuheng Admin、Yuheng Engine、两个订单 Provider、Yuheng Web、Tianshu Web。使用 readiness 轮询；不使用固定长 sleep。生成新的 `target/local-biz-app-run/admin.jwt`，权限设为仅当前用户可读，不打印内容。

- [ ] **Step 5: 验证 optional filter、可见性和实例身份**

```text
GET /api/v1/tianshu/registry/services
GET /api/v1/tianshu/registry/services?serviceKind=INTERNAL_GATEWAY&protocol=grpc
GET /api/v1/tianshu/registry/services?bizCode=infra&namespaceCode=default&env=local
GET /api/v1/tianshu/configs?includeDeleted=false
GET /api/v1/tianshu/configs?bizCode=infra&namespaceCode=default&env=local&appCode=ge
```
...
Yuheng Web 登录页本地模式不显示 Refresh Token；Tianshu Web 首次空筛选能加载列表；重复请求已发布订单路由，响应中的非敏感 instance 标识覆盖 18084 和 18085 两个副本。不得使用浏览器或 Computer Use，使用 HTTP、前端测试和构建产物完成验证。
...
- Spec coverage: V7 关系模型、环境级多对多、配置共享、V3 服务目录、serviceId、instanceId Strategy、optional filters、Tianshu Web、Yuheng 登录、ga/ge 注册、两个订单副本和最终保持运行分别由 Tasks 1-9 覆盖。
...
- Identity consistency: serviceId 是同一 canonical 的 SHA-256；同一副本跨 Tianshu Config/HTTP/RPC/Yuheng runtime 使用同一基础 instanceId；每个注册会话使用独立 leaseId。
- Query consistency: services/configs 可空或部分筛选；instances 精确查询；未知值成功返回空结果。
- Pattern decision: binding 使用 Association Object，实例 ID 使用 Strategy，Yuheng 继续使用既有 Adapter/lease runtime；未增加无收益的抽象层。
