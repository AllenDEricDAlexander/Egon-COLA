...
class NativeOrganizationRpcContractTest {
    ...
    private static final Map<String, Set<String>> OPERATIONS = Map.of(
            ...
            "Permission", Set.of("GrantPermission", "GetPermissionTree"),
            "Grade", Set.of("CreateGrade", "GetGrade"),
            "SchoolClass", Set.of("CreateSchoolClass", "GetSchoolClass", "AssignUser")
    );
    ...
    @top.egon.cola.component.rpc.annotation.EgonRpcService(grpcClass = top.egon.cola.organization.facade.rpc.proto.UserServiceGrpc.class)
    interface MismatchedRpcService {
        @top.egon.cola.component.rpc.annotation.EgonRpcMethod(name = "GetUser")
    ...
    interface OverloadedRpcService {
        ...
        @top.egon.cola.component.rpc.annotation.EgonRpcMethod(name = "GetUser")
        com.google.protobuf.Empty get(top.egon.cola.organization.facade.rpc.proto.GetUserRpcRequest request);
    }
}
