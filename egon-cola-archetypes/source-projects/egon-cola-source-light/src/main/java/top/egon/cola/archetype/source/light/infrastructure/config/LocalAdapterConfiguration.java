...
import top.egon.cola.archetype.source.light.infrastructure.teaching.cache.InMemoryCourseCacheService;
import top.egon.cola.archetype.source.light.infrastructure.teaching.client.impl.LocalTeachingQueryService;
import top.egon.cola.archetype.source.light.infrastructure.teaching.mq.LocalTeachingEventPublisher;
import top.egon.cola.archetype.source.light.infrastructure.user.cache.InMemoryUserCacheService;
import top.egon.cola.archetype.source.light.infrastructure.user.client.impl.LocalUserQueryService;
import top.egon.cola.archetype.source.light.infrastructure.user.mq.LocalUserEventPublisher;
