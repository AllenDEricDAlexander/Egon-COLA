...
public class RoleRepository extends EgonColaRepository<RoleDAO, RolePO> {
    @Getter
    @Qualifier("roleDAO")
    private final RoleDAO baseMapper;
    ...
    public List<RolePO> selectByCode(@NotBlank String code) {
