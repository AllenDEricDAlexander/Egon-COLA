...
import top.egon.cola.archetype.source.light.infrastructure.teaching.dao.SchoolClassDAO;
...
@CacheConfig(cacheNames = "SchoolClassPO")
public class SchoolClassRepository extends EgonColaRepository<SchoolClassDAO, SchoolClassPO> {
    ...
    public SchoolClassPO findCachedById(@NotNull @Positive Long id) {
        return getById(id);
    }
    ...
    public boolean updateCachedById(@NotNull SchoolClassPO entity) {
