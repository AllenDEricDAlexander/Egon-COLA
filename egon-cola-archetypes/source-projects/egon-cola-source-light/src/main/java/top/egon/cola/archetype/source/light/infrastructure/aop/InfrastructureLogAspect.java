package top.egon.cola.archetype.source.light.infrastructure.aop;
...
public class InfrastructureLogAspect {
    ...
    @Around("execution(* top.egon.cola.archetype.source.light.infrastructure..client.impl..*.*(..))"
            + " || (execution(* *(..)) && within(top.egon.cola.archetype.source.light.infrastructure.mq.impl..*))")
