...
@ControllerAdvice(basePackages = "top.egon.cola.archetype.source.lightopen.adapter")
public class ResponseWrapperHandler implements ResponseBodyAdvice<Object> {
    ...
    public boolean supports(
        ...
        return packageName.startsWith("top.egon.cola.archetype.source.lightopen.adapter.")
