...
import top.egon.cola.archetype.source.service.application.exam.manage.impl.ExamManageImpl;
...
class ExamManageTest {
    ...
    void shouldCreateExamForExistingCourse() {
        ...
        Exam exam = new Exam(new ExamId(4001L), new top.egon.cola.archetype.source.service.domain.course.vos.CourseId(1001L),
