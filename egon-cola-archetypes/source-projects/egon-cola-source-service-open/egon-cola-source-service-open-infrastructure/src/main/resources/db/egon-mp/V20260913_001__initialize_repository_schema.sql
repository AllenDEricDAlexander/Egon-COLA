-- Complete PostgreSQL initialization for service-open; requires an empty managed schema.
DO $egon$
BEGIN
    ...
    ELSIF current_setting('egon_migration.role') = 'SHARD' THEN
        ...
        CREATE INDEX idx_exam_0_course_created ON evaluation_exam_0 (course_id, created_at, id);
        ...
        CREATE INDEX idx_exam_1_course_created ON evaluation_exam_1 (course_id, created_at, id);
        ...
        CREATE TABLE evaluation_exam_paper_0 (
            ...
            CONSTRAINT fk_exam_paper_0_exam FOREIGN KEY (exam_id) REFERENCES evaluation_exam_0(id),
        ...
        CREATE TABLE evaluation_exam_paper_1 (
            ...
            CONSTRAINT fk_exam_paper_1_exam FOREIGN KEY (exam_id) REFERENCES evaluation_exam_1(id),
        ...
        CREATE TABLE evaluation_score_0 (
            ...
            CONSTRAINT fk_score_0_exam FOREIGN KEY (exam_id) REFERENCES evaluation_exam_0(id),
            CONSTRAINT ck_score_0_points CHECK (points BETWEEN 0 AND 100)
        );

        CREATE INDEX idx_score_0_exam_created ON evaluation_score_0 (exam_id, created_at, id);
        ...
        CREATE TABLE evaluation_score_1 (
            ...
            CONSTRAINT fk_score_1_exam FOREIGN KEY (exam_id) REFERENCES evaluation_exam_1(id),
            CONSTRAINT ck_score_1_points CHECK (points BETWEEN 0 AND 100)
        );

        CREATE INDEX idx_score_1_exam_created ON evaluation_score_1 (exam_id, created_at, id);
