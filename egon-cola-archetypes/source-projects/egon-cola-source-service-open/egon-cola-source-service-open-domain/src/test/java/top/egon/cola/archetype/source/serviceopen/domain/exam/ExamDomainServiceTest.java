...
class ExamDomainServiceTest {
    ...
    void shouldPublishExamAndPaperTogetherAfterValidation() {
        ...
        Exam exam = new Exam(
                new ExamId(4001L), new top.egon.cola.archetype.source.serviceopen.domain.course.vos.CourseId(course.getId()),
    ...
    void shouldRejectPaperWithWrongExam() {
        Exam exam = new Exam(
                new ExamId(4001L), new top.egon.cola.archetype.source.serviceopen.domain.course.vos.CourseId(1001L),
                "Midterm", Instant.EPOCH, Instant.EPOCH.plusSeconds(60), ExamStatus.DRAFT);
        ExamPaper paper = new ExamPaper(
