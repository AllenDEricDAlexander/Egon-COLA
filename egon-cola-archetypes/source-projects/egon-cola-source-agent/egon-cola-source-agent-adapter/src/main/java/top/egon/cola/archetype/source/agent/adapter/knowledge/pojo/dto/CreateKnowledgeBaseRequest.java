package top.egon.cola.archetype.source.agent.adapter.knowledge.pojo.dto;
...
public record CreateKnowledgeBaseRequest(
        ...
        @NotNull @Valid ChunkingConfigRequest chunkConfig) implements BasePojo {
    ...
    public record ChunkingConfigRequest(
            ...
            @Schema(example = "[1,2,3]") List<@Min(1) @Max(6) Integer> headingLevels) implements BasePojo {
