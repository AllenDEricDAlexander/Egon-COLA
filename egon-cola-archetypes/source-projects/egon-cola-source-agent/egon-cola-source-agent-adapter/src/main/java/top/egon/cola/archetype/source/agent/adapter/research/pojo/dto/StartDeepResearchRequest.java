package top.egon.cola.archetype.source.agent.adapter.research.pojo.dto;
...
public record StartDeepResearchRequest(
        ...
        @Min(3) @Max(20) @Schema(example = "8", minimum = "3", maximum = "20") Integer maxSources) implements BasePojo {
