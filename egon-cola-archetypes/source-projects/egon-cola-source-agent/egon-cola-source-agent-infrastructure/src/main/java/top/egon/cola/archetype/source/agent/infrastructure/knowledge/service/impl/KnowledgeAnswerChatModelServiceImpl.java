package top.egon.cola.archetype.source.agent.infrastructure.knowledge.service.impl;
...
@Slf4j
public class KnowledgeAnswerChatModelServiceImpl implements KnowledgeAnswerService {
    ...
    public KnowledgeAnswerRunService generate(KnowledgeAnswerTaskBO task, KnowledgeQaEventObserverService observer) {
        ...
        return new AnswerRun(terminal, subscription);
    }
    ...
    private static final class AnswerRun implements KnowledgeAnswerRunService {
        ...
        private AnswerRun(AtomicBoolean terminal, AtomicReference<Disposable> subscription) {
