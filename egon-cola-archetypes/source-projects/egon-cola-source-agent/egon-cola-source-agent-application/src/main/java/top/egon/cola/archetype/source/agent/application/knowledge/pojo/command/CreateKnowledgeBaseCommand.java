package top.egon.cola.archetype.source.agent.application.knowledge.pojo.command;
...
public record CreateKnowledgeBaseCommand(
        ...
        @NotBlank @Size(max = 128) String traceId) implements BasePojo {
    ...
    public record ChunkingConfigCommand(
            ...
            List<@Min(1) @Max(6) Integer> headingLevels) implements BasePojo {
