...
更新：2026-09-22。以 `egon-cola-source-web-open` 的 POM、Java 和架构测试为事实来源。Organization HTTP/GraphQL/MQ；Web 使用自有 Organization Facade 和外部 Evaluation Facade。
...
以下入口相对正常源工程 `egon-cola-source-web-open`；生成工程替换项目/包名前缀。修改前重查源码，不按旧文档猜类名。

| 责任 | 源码入口 |
| --- | --- |
| Domain 业务端口 | `egon-cola-source-web-open-domain/src/main/java/top/egon/cola/archetype/source/webopen/domain/service/CommandIdempotencyService.java` |
| Domain 业务端口 | `egon-cola-source-web-open-domain/src/main/java/top/egon/cola/archetype/source/webopen/domain/service/OrganizationEventService.java` |
| Domain 业务端口 | `egon-cola-source-web-open-domain/src/main/java/top/egon/cola/archetype/source/webopen/domain/teaching/service/EvaluationQueryService.java` |
| Application 用例 | `egon-cola-source-web-open-application/src/main/java/top/egon/cola/archetype/source/webopen/application/teaching/manage/GradeManage.java` |
| Application 用例 | `egon-cola-source-web-open-application/src/main/java/top/egon/cola/archetype/source/webopen/application/teaching/manage/SchoolClassManage.java` |
| Application 用例 | `egon-cola-source-web-open-application/src/main/java/top/egon/cola/archetype/source/webopen/application/user/manage/PermissionManage.java` |
| Infrastructure Repository | `egon-cola-source-web-open-infrastructure/src/main/java/top/egon/cola/archetype/source/webopen/infrastructure/teaching/repo/GradeRepository.java` |
| Infrastructure Repository | `egon-cola-source-web-open-infrastructure/src/main/java/top/egon/cola/archetype/source/webopen/infrastructure/teaching/repo/SchoolClassRepository.java` |
| Infrastructure Repository | `egon-cola-source-web-open-infrastructure/src/main/java/top/egon/cola/archetype/source/webopen/infrastructure/teaching/repo/SchoolClassUserRepository.java` |
| 架构校验 | `egon-cola-source-web-open-starter/src/test/java/top/egon/cola/archetype/source/webopen/architecture/OpenArchitectureTest.java` |
| 架构校验 | `egon-cola-source-web-open-starter/src/test/java/top/egon/cola/archetype/source/webopen/architecture/WebOpenPersistenceArchitectureTest.java` |
