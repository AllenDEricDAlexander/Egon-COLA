...
更新：2026-09-22。以 `egon-cola-source-service` 的 POM、Java 和架构测试为事实来源。Evaluation RPC/MQ，保留 Service-only 边界。
...
以下入口相对正常源工程 `egon-cola-source-service`；生成工程替换项目/包名前缀。修改前重查源码，不按旧文档猜类名。

| 责任 | 源码入口 |
| --- | --- |
| Domain 业务端口 | `egon-cola-source-service-domain/src/main/java/top/egon/cola/archetype/source/service/domain/course/service/CourseDomainService.java` |
| Domain 业务端口 | `egon-cola-source-service-domain/src/main/java/top/egon/cola/archetype/source/service/domain/course/service/CourseEventService.java` |
| Domain 业务端口 | `egon-cola-source-service-domain/src/main/java/top/egon/cola/archetype/source/service/domain/course/service/OrganizationDirectoryService.java` |
| Application 用例 | `egon-cola-source-service-application/src/main/java/top/egon/cola/archetype/source/service/application/course/manage/CourseManage.java` |
| Application 用例 | `egon-cola-source-service-application/src/main/java/top/egon/cola/archetype/source/service/application/exam/manage/ExamManage.java` |
| Application 用例 | `egon-cola-source-service-application/src/main/java/top/egon/cola/archetype/source/service/application/exam/manage/ScoreManage.java` |
| Infrastructure Repository | `egon-cola-source-service-infrastructure/src/main/java/top/egon/cola/archetype/source/service/infrastructure/course/repo/CourseRepository.java` |
| Infrastructure Repository | `egon-cola-source-service-infrastructure/src/main/java/top/egon/cola/archetype/source/service/infrastructure/course/repo/CourseScheduleRepository.java` |
| Infrastructure Repository | `egon-cola-source-service-infrastructure/src/main/java/top/egon/cola/archetype/source/service/infrastructure/exam/repo/ExamPaperRepository.java` |
| 架构校验 | `egon-cola-source-service-starter/src/test/java/top/egon/cola/archetype/source/service/architecture/EvaluationPersistenceArchitectureTest.java` |
