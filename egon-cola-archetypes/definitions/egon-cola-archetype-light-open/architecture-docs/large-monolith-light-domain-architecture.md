...
更新：2026-09-22。以 `egon-cola-source-light-open` 的 POM、Java 和架构测试为事实来源。单模块业务工程，按现有 HTTP/GraphQL/MQ 入口和 start 装配。

## 项目与模块

一个 Maven 工程，使用 common、facade、domain、application、infrastructure、adapter、start 的现有包职责，不拆成七个模块。


## 当前源码定位

以下入口相对正常源工程 `egon-cola-source-light-open`；生成工程替换项目/包名前缀。修改前重查源码，不按旧文档猜类名。

| 责任 | 源码入口 |
| --- | --- |
| Domain 业务端口 | `src/main/java/top/egon/cola/archetype/source/lightopen/domain/teaching/service/CourseDomainService.java` |
| Domain 业务端口 | `src/main/java/top/egon/cola/archetype/source/lightopen/domain/teaching/service/CourseIdempotencyService.java` |
| Domain 业务端口 | `src/main/java/top/egon/cola/archetype/source/lightopen/domain/teaching/service/SchoolClassDomainService.java` |
| Application 用例 | `src/main/java/top/egon/cola/archetype/source/lightopen/application/teaching/manage/CourseManage.java` |
| Application 用例 | `src/main/java/top/egon/cola/archetype/source/lightopen/application/teaching/manage/SchoolClassManage.java` |
| Application 用例 | `src/main/java/top/egon/cola/archetype/source/lightopen/application/user/manage/PermissionManage.java` |
| Infrastructure Repository | `src/main/java/top/egon/cola/archetype/source/lightopen/infrastructure/teaching/repo/ClassCourseScheduleRepository.java` |
| Infrastructure Repository | `src/main/java/top/egon/cola/archetype/source/lightopen/infrastructure/teaching/repo/CourseRepository.java` |
| Infrastructure Repository | `src/main/java/top/egon/cola/archetype/source/lightopen/infrastructure/teaching/repo/SchoolClassRepository.java` |
| 架构校验 | `src/test/java/top/egon/cola/archetype/source/lightopen/architecture/OpenArchitectureTest.java` |
