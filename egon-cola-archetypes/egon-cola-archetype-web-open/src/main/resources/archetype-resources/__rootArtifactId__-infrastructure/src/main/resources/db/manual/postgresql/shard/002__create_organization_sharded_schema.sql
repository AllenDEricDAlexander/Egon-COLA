-- Web Open sharded schema for PostgreSQL. Execute manually on every shard primary.
...
CREATE INDEX IF NOT EXISTS idx_school_classes_0_grade_id
    ON school_classes_0 (grade_id);
CREATE INDEX IF NOT EXISTS idx_school_classes_1_grade_id
    ON school_classes_1 (grade_id);
CREATE INDEX IF NOT EXISTS idx_school_class_users_0_grade_class
    ON school_class_users_0 (grade_id, school_class_id);
CREATE INDEX IF NOT EXISTS idx_school_class_users_1_grade_class
