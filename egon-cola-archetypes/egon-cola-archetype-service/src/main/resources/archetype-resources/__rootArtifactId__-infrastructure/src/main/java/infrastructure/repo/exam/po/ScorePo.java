...
public class ScorePo {
    ...
    protected ScorePo() { }
    public ScorePo(String id, String examId, String courseId, String studentId, int points,
                   String status, Instant createdAt, Instant updatedAt) {
        this.id = id; this.examId = examId; this.courseId = courseId; this.studentId = studentId;
        this.points = points; this.status = status; this.createdAt = createdAt; this.updatedAt = updatedAt;
    }
