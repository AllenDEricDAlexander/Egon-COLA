...
frontends=(
  "idp-admin-web|${unified_platform_repo_root}/egon-cola-xingyuan/egon-cola-tianquan-shoubing/egon-cola-tianquan-shoubing-admin-web|${IDP_ADMIN_WEB_URL}/src/auth/CentralLoginPage.tsx"
  "rbac3-admin-web|${unified_platform_repo_root}/egon-cola-xingyuan/egon-cola-tianquan-jianshen/egon-cola-tianquan-jianshen-admin-web|${RBAC3_ADMIN_WEB_URL}/src/features/auth/LoginPage.tsx"
  "gateway-admin-web|${unified_platform_repo_root}/egon-cola-xingyuan/egon-cola-yuheng/yuheng-admin-web|${GATEWAY_ADMIN_WEB_URL}/src/auth/LoginPage.tsx"
  "ddc-admin-web|${unified_platform_repo_root}/egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-admin-web|${DDC_ADMIN_WEB_URL}/src/auth/LoginPage.tsx"
  "portal-web|${unified_platform_repo_root}/egon-cola-xingyuan/egon-cola-xingyuan-admin-portal|${PLATFORM_PORTAL_URL}/src/app/PortalLayout.tsx"
)
