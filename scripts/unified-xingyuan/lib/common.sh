...
DDC_RPC_TARGET="${DDC_RPC_TARGET:-dns:///127.0.0.1:19080}"
...
GATEWAY_MCP_BASE_URL="${GATEWAY_MCP_BASE_URL:-http://127.0.0.1:18185}"
GATEWAY_MCP_ENGINE_BASE_URL="${GATEWAY_MCP_ENGINE_BASE_URL:-http://127.0.0.1:18186}"
...
unified_platform_write_frontend_login_env() {
  ...
  local marker='# Managed by scripts/unified-xingyuan for Gateway USER cookies.'
