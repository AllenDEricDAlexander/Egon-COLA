...
gateway_web_dir="${unified_platform_repo_root}/egon-cola-xingyuan/egon-cola-yuheng/yuheng-admin-web"
portal_web_dir="${unified_platform_repo_root}/egon-cola-xingyuan/egon-cola-xingyuan-admin-portal"
idp_web_dir="${unified_platform_repo_root}/egon-cola-xingyuan/egon-cola-tianquan-shoubing/egon-cola-tianquan-shoubing-admin-web"
rbac3_root_dir="${unified_platform_repo_root}/egon-cola-xingyuan/egon-cola-tianquan-jianshen"
rbac3_web_dir="${rbac3_root_dir}/egon-cola-tianquan-jianshen-admin-web"
ddc_web_dir="${unified_platform_repo_root}/egon-cola-xingyuan/egon-cola-tianshu/egon-cola-tianshu-admin-web"
gateway_engine_jar="${unified_platform_repo_root}/egon-cola-xingyuan/egon-cola-yuheng/yuheng-biz-gateway/target/yuheng-biz-gateway-exec.jar"
gateway_mcp_engine_jar="${unified_platform_repo_root}/egon-cola-xingyuan/egon-cola-yuheng/yuheng-mcp-gateway/target/yuheng-mcp-gateway-exec.jar"
mcp_provider_jar="${unified_platform_repo_root}/egon-cola-xingyuan/egon-cola-yuheng/yuheng-test/yuheng-test-mcp-provider/target/gateway-test-mcp-provider-exec.jar"
...
enable_gateway_release_reconciliation() {
  ...
  unified_platform_start_jar gateway-admin \
    "${unified_platform_env_dir}/gateway-admin.env" \
    "${unified_platform_repo_root}/egon-cola-xingyuan/egon-cola-yuheng/yuheng-admin/target/yuheng-admin-exec.jar"
