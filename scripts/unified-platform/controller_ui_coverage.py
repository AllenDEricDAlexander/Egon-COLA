...
def _platform_roots(repo_root: Path) -> list[tuple[str, Path, Path]]:
    platforms_root = repo_root / "egon-cola-platforms"
    return [
        ("IDP", platforms_root / "egon-cola-platform-idp/egon-cola-platform-idp-admin/src/main/java", platforms_root / "egon-cola-platform-idp/egon-cola-platform-idp-admin-web"),
        ("RBAC3", platforms_root / "egon-cola-platform-rbac3/egon-cola-platform-rbac3-admin/src/main/java", platforms_root / "egon-cola-platform-rbac3/egon-cola-platform-rbac3-admin-web"),
        ("Gateway", platforms_root / "egon-cola-platform-gateway/egon-cola-platform-gateway-admin/src/main/java", platforms_root / "egon-cola-platform-gateway/egon-cola-platform-gateway-admin-web"),
        ("DDC", platforms_root / "egon-cola-platform-dynamic-config-center/egon-cola-platform-dynamic-config-center-admin/src/main/java", platforms_root / "egon-cola-platform-dynamic-config-center/egon-cola-platform-dynamic-config-center-admin-web"),
    ]
